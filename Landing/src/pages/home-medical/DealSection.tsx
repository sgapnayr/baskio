      ...
      <section>
        <Container>
          ...
          <div className="my-5 pb-md-5">
            <div className="Baskio-medical-deal-section">
              <h4 className="product-cd-header text-center fs-25 d-inline-flex bg-body align-items-center mb-0">
                ...
                {dealData.map((product, index) => (
                  <SwiperSlide key={index}>
                    <div>
                      ...
                      <div
                        x-data="{ imageUrl: 'assets/images/home-medical/pr-20.jpg' }"
                      ...
                      >
                        <div className="position-relative overflow-hidden">
                          ...
                          >
                            <Link
                              href="#"
                              className="text-white wishlistadd position-absolute"
                            >
                          ...
                          <div className="product-button d-none d-lg-flex flex-column gap-2">
                            <Link
                              ...
                              className="btn rounded-pill fs-14 text-white"
                            >
                          ...
                          <div
                            className="position-absolute d-lg-none bottom-0 end-0 d-flex flex-column bg-primary rounded-pill m-2"
                            style={{ zIndex: "1" }}
                          >
                            <Link
                              href="#exampleModal"
          ...
          <Row className="mt-30">
            <Col lg={8}>
              <Link
                href="/shop"
                className="Baskio-medical-banner-01 position-relative img-zoom d-inline-block"
              >
            ...
            <Col lg={4}>
              <Link
                href="/shop"
                className="Baskio-medical-banner-01 position-relative img-zoom d-inline-block w-100"
              >
                ...
                <div className="content position-absolute text-body">
                  ...
                  <div className="d-inline-block text-white btn btn-primary rounded-pill">
                    Shop Now
                  </div>
                </div>
              </Link>
