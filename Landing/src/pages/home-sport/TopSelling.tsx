      ...
      <div className="col-6 col-sm-4 col-md-3">
        ...
        >
          <div className="position-relative overflow-hidden main">
            ...
            <Image
              src={isHovered ? sell.hoverImageUrl : imageUrl}
              alt=""
              className="img-fluid"
            />
            <OverlayTrigger
          ...
          <div className="mt-3 text-center">
            ...
            <p className="mb-0 fs-14 text-muted">
              ...
              <span className={sell.discount ? "text-danger" : ""}>
                {sell.price}
              </span>
            </p>
            {sell.colorOptions && (
              <div className="product-color-list mt-2 gap-2 d-flex align-items-center justify-content-center">
                {sell.colorOptions.map(
                  (
                    color: { imageUrl: any; colorClass: any },
                    index: React.Key | null | undefined
                  ) => (
                    <Link
                      key={index}
                      href="#!"
                      onClick={() => setImageUrl(color.imageUrl)}
