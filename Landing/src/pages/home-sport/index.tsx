              ...
              <Col lg={12}>
                <div className="Baskio-medical-banner-01 position-relative img-zoom">
                  ...
                  <div className="content position-absolute text-white py-5">
                    <p className="text-uppercase fs-16 fw-semibold mb-1">
                      BLACK FRIDAY
                    </p>
                    <h3 className="font-montserrat fw-bold display-3 text-uppercase">
                      SAVE 50% OFF
                    </h3>
                    <h2 className="text-uppercase fs-36 fw-bold mb-4">
                      FIRST ONLINE PURCHASE
                    </h2>
                    <button className="btn btn-custom-orange rounded-0 min-w-150 min-h-45 text-uppercase d-inline-flex align-items-center justify-content-center fw-semibold">
                      VIEW PROMOTION
                    </button>
                  </div>
                </div>
