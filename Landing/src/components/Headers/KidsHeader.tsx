...
import {
  ...
  ShopFeatures2,
  ProductDetail2,
} from "@src/common/Header/headerkids";
...
const KidsHeader = () => {
  ...
  const handleClickOutSide = (event: any) => {
    if (dropdownref.current && !event.target.closest(".demo")) {
      setShoww(false);
    }
  };
  useEffect(() => {
  ...
  return (
    <React.Fragment>
      <div id="Baskio-section-header_top ">
            ...
            <Row className="align-items-center justify-content-center py-3 py-xl-0">
              ...
              <Col md={5} lg={6} className="col-12">
                <div className="header-text text-center fs-12 py-1 py-lg-0">
                  Summer sale discount off <span className="fw-bold">50% </span>{" "}
        ...
        <nav className="navbar navbar-expand-lg navbar-custom pt-4 pb-0 d-block align-items-center">
                ...
                <Row>
                    ...
                    >
                      <div className="footer-subscribe position-relative electrict-input ps-2">
                        <input
                          ...
                          className="ps-4 input-text input-search form-control w-100 rounded-pill"
                          readOnly
                        />
                        <button
                          type="submit"
                          className="btn btn-pink2 position-absolute search-btn rounded-pill top-0 end-0"
                        >
                          <span>Search</span>
                        </button>
                      </div>
                  ...
                  <div className="mt-2 col-3">
                    <div className="topbar-toolbar d-flex justify-content-end align-items-center gap-3">
                      ...
                      <Link
                        className="main_link_primary d-md-block d-none"
                        href="#!"
                      >
          ...
          <div
            className="bg-blue-dark text-white d-none d-lg-block demo"
            ref={dropdownref}
          >
            <div className="container">
                    ...
                    <Dropdown>
                      ...
                      >
                        <div className="nav-link text-uppercase text-white align-items-center fw-medium">
                          <i className="las la-bars mr__5 fs-18 me-1"></i> Shop
                          by category
                        </div>
                      </Dropdown.Toggle>
                            ...
                            <Col lg={6} className="p-0">
                              <div className="dropdown-sub-column-item position-relative cat_grid_item overflow-hidden h-100">
                                ...
                                <Link
                                  ...
                                  className="btn bg-white px-5 fw-medium mb-4 position-absolute bottom-0 start-50 translate-middle-x"
