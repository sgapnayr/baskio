...
const HomeSection = () => {
  ...
  return (
    <React.Fragment>
      <div className="Baskio-home-section type_slideshow type_carousel Baskio-medical Baskio-bags">
              ...
              <Row className="justify-content-end">
                <Col lg={6}>
                  <div className="content text-end">
                    ...
                    <h1 className="display-3 fw-bold text-white mb-1">
                      20% OFF
                    </h1>
                    <h1 className="fs-50 fw-bold text-white mb-3">
                      ONE FULL PRICE ITEM
                    </h1>
                    <Link
                      href="/shop"
              ...
              <Row className="justify-content-end">
                <Col lg={6}>
                  <div className="content">
                    <h5 className="text-white fs-18 fw-medium">
                      WE ARE Baskio
                    </h5>
                    <h1 className="display-3 fw-bold text-white mb-4">
                      No Matter What Lifestyle You Live
                    </h1>
                    <Link
                      href="/shop"
                      className="btn text-white btn-custom-white-red btn_icon_true fw-medium min-w-150 rounded-0 py-3 px-5 text-uppercase fs-17"
