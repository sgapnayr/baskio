    ...
    <React.Fragment>
      ...
      >
        <nav
          ...
          } ${showMenuScroll ? "bg-white shadow-sm" : ""}`}
        >
              ...
              <div className="col-lg-5 col-auto">
                ...
                >
                                      ...
                                      return (
                                        <li key={index}>
                                          ...
                                          >
                                            {item.label}
                                            <span
                                              className={item.homebagbadgeColor}
                                            >
                                              {item.homebagbadge}
                                            </span>
                                          </Link>
                  ...
                  <MobileHeader
                    ...
                    handleHeaderClose={handleHeader}
                  />
                </div>
              </div>
      ...
      <div
        className="position-fixed bottom-0 bg-body start-0 end-0 z-1"
        style={{ boxShadow: "0 0 9px rgba(0, 0, 0, 0.12)" }}
      >
          ...
          <div className="d-md-flex text-center align-items-center justify-content-between py-3">
            ...
            <div className="mt-3 mt-md-0">
              <button
                ...
                aria-controls="shoppingCartOffcanvas"
                className="btn btn-teal text-uppercase rounded-0 min-w-150"
                onClick={handleShoppingShow}
              >
                accept
              </button>
