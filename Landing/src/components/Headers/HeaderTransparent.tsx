  ...
  return (
    <React.Fragment>
      <div
        ...
        className="header-decor demo"
        ref={headerRef}
      >
        <nav
          className={`navbar navbar-expand-lg navbar-custom py-0 d-flex align-items-center px-lg-3 ${
            showMenuScroll ? "bg-body navbar-scroll shadow-sm" : ""
          }`}
        >
          {" "}
