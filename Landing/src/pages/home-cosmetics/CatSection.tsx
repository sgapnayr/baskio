              ...
              <div className="text-center mb-4 pb-2">
                <div>
                  <h1 className="position-relative text-capitalize font-playfair text-lima fw-medium">
                    <span>Welcome to Baskio Natural Skincare</span>
                  </h1>
            ...
            <Col md={6}>
              <div className="row g-4">
                <Col lg={12}>
                  <Link
                    href="#!"
                    className="d-block position-relative cat_grid_item overflow-hidden h-505"
                  >
                    <div
                ...
                <Col lg={12}>
                  <Link
                    href="#!"
                    className="d-block position-relative cat_grid_item overflow-hidden h-315"
                  >
                    <div
                      className="h-100 w-100 cat-grid-img"
            ...
            <Col md={6}>
              <div className="row g-4">
                <Col lg={12}>
                  <Link
                    href="#!"
                    className="d-block position-relative cat_grid_item overflow-hidden h-410"
                  >
                    <div
                      className="h-100 w-100 cat-grid-img"
