...
const MainBanner = () => {
  return (
    <React.Fragment>
      <section className="mt-3 Baskio-decor-cat-banner-layout">
        <Container fluid>
            ...
            <Col lg={6} className="pe-md-0">
              <Row className="g-3">
                ...
                <Col md={6}>
                  ...
                  >
                    ...
                    <div className="position-absolute bottom-0 start-50 translate-middle-x d-flex m-3">
                      <div className="text-dark text-center">
                        <h4
                          className="fs-30 fw-semibold mb-2"
                ...
                <Col md={8}>
                  <Link
                    href="/shop"
                    className="position-relative hover-zoom d-block h-100"
                  >
                    <Image
                      src={cat2}
                      alt=""
                      className="img-fluid hover-zoom-img w-100 h-100"
                    />
                    <div className="position-absolute top-0 end-0 d-flex m-3">
                      <div className="text-dark text-center">
                ...
                <Col md={4}>
                  <Link
                    href="/shop"
                    className="position-relative hover-zoom d-block bg-light"
                  >
                    <Image
                      src={banner5}
                      alt=""
                    ...
                    />
                    <div className="position-absolute bottom-0 start-50 translate-middle-x d-flex m-3">
                      <h4 className="fs-30 fw-semibold mb-2 text-dark">
                        bottles
                      </h4>
                    </div>
                  </Link>
              ...
              >
                ...
                <div className="position-absolute top-0 start-0 d-flex m-3">
                  <div className="text-light">
                    <h4 className="fs-30 fw-semibold mb-2">
