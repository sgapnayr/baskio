      ...
      <div id="Baskio-section-header_top" className="demo" ref={headerRef}>
        ...
        >
          <div className="container-fluid">
            ...
            <Link className="navbar-brand fs-14" href="#">
              ...
              <div className="d-none d-lg-block mx-auto">
                <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                  ...
                  <li className="nav-item dropdown dropdown-mega-xxl">
                    ...
                    >
                      <Row className="g-0">
                        ...
                        <Col lg={7}>
                          <Row className="g-0">
                            {layout2Image.map((item: any, index: number) => {
                              return (
                                <Col lg={6} key={index}>
                                  <div className="dropdown-sub-column-item text-center position-relative cat_grid_item overflow-hidden h-100">
                                    <Image
                                      ...
                                      className="img-fluid"
                                    />
                                    <Link className={item.pt} href={item.link}>
                                      {item.label}
                                    </Link>
                  ...
                  <li className="nav-item">
                    <Link className="navbar-brand nav-link me-0" href="#">
