...
const ShoesSection = () => {
  return (
    <React.Fragment>
      <div>
        <section className="Baskio-shoes-grid-banner">
              ...
              <Col md={4}>
                <div className="row g-2">
                  <Col lg={12}>
                    <Link
                      href="/shop"
                      className="overflow-hidden img-zoom position-relative d-block"
                    >
                      <Image src={grid1} alt="" className="img-fluid w-100" />
                      <div className="position-absolute bottom-0 text-white p-4 m-2">
                        <h3 className="fs-30 fw-medium mb-1">
                          Ultra Boost Shoes
                        </h3>
                        <p className="fw-medium mb-0">
                          SHOP ADIDAS <i className="las la-angle-right"></i>
                        </p>
                      </div>
                    </Link>
                  </Col>
                  <Col lg={12}>
                    ...
                    >
                      ...
                      <div className=" position-absolute bottom-0 text-white p-4 m-2">
                        ...
                        <p className="fw-medium mb-0">
                          SHOP ECCO <i className="las la-angle-right"></i>
                        </p>
                      </div>
                    </Link>
                  </Col>
                  ...
                  <Col lg={12}>
                    ...
                    >
                      ...
                      <div className="position-absolute bottom-0 text-white p-4 m-2">
                        ...
                        <p className="fw-medium mb-0">
                          SHOP TOMS <i className="las la-angle-right"></i>
                        </p>
                      </div>
                    </Link>
                  </Col>
                  <Col lg={12}>
                    ...
                    >
                      ...
                      <div className="position-absolute bottom-0 text-white p-4 m-2">
                        ...
                        <p className="fw-medium mb-0">
                          SHOP CONVERSE <i className="las la-angle-right"></i>
                        </p>
                      </div>
                    </Link>
                  </Col>
              ...
              <Col md={4}>
                ...
                >
                  ...
                  <div className="position-absolute bottom-0 text-white p-4 m-2">
                    ...
                    <p className="fw-medium mb-0">
                      SHOP NOW <i className="las la-angle-right"></i>
                    </p>
                  </div>
                </Link>
              </Col>
