...
const HomeSection = () => {
  ...
  const data = [
    {
      id: 1,
      pic: slide1,
      title: "Smart Clothing For Any Situation",
      desc: "Baskio’s Beachwear Etiquette 2020",
      btn: "Explore Collection",
    },
    {
      id: 2,
      pic: slide2,
      title: "Latest Arrivals Collection on 50% Off",
      desc: "Natural Febric Is 100% Unrefined",
      btn: "Discover More",
    },
  ];
  ...
  return (
    <React.Fragment>
      <section className="Baskio-home-section type_slideshow type_carousel Baskio-bags Baskio-medical overflow-hidden">
                ...
                <Row className="justify-content-end">
                  <Col lg={6}>
                    <div className="content text-center text-md-start">
                      ...
                      <h1 className="display-3 fw-normal font-futura mb-4">
                        {item.desc}
                      </h1>
                      <Link
