          ...
          <Row className="py-3 gx-xl-1">
            ...
            <Col md={6} className="mt-5 mt-md-0">
              ...
              <div className="d-flex flex-wrap justify-content-between">
                <p className="text-muted fs-18 mb-4">
                  <del>$75.00</del>
                ...
                <div id="tab_reviews_product">
                  <div className="Baskio-rating-result">
                    <span className="Baskio-rating-result__pipe">
                      ...
                      <span className="Baskio-rating-result__start Baskio-rating-result__start--big de-active me-1"></span>
                    </span>
              ...
              <div>
                ...
                <div className="product-color-list mt-2 gap-2 d-flex align-items-center">
                  ...
                  <Link
                    href="#!"
                    className={`d-inline-block bg-secondary bg-opacity-50 rounded-circle ${
                      color === "Grey" ? "active" : ""
                    } square-xs`}
                    data-bs-toggle="tooltip"
                    data-bs-placement="top"
              ...
              <div className="d-flex flex-wrap align-items-center gap-2 mt-4">
                ...
                <Button
                  variant="teal"
                  className="btn btn-teal text-uppercase rounded-pill min-w-150"
                ...
                <div className="row align-items-center mb-5">
                  <div className="col-xl-6">
                    <ul className="list-unstyled m-0 p-0 d-flex flex-wrap align-items-center gap-2">
                      ...
                      <li className="d-inline-block fs-4 text-muted">+</li>
                      <li className="d-inline-block">
                        <Link href="/product-detail-layout-01">
                          <Image
                            src={thumbs2}
                  ...
                  <div className="col-xl-6 mt-4 mt-xl-0">
                    <p className="text-muted fs-18">
                      <span className="fs-14">Total price:</span>
                      <span>
                        <del>$117.00</del>{" "}
                        <span className="text-danger">$75.50</span>
                      </span>
                    </p>
                    <button
                      type="button"
                      ...
                      className="btn btn-teal rounded-pill text-uppercase fw-semibold px-4"
                      onClick={handleShoppingShow}
                    >
                    ...
                    <ul className="list-unstyled m-0 p-0 vstack gap-3">
                      <li className="d-flex flex-wrap align-items-center">
                        <input
                          type="checkbox"
                          defaultChecked
                          className="form-check-input checkbox-product me-2"
                          id="kl_fbt_ck_1"
                        />

                        <span className="text-muted">
                          <strong>This item:</strong> Striped Long Sleeve Top
                        </span>
                        <select
                          className="form-select w-auto d-inline-block ps-2 pe-4 py-1 mx-2"
                          style={{
                            backgroundPosition: "right .5rem center",
                            backgroundSize: "12px 10px",
                          }}
                        >
                          <option value="black-s" defaultValue="black / S">
                            Black / S
                          </option>
                      ...
                      <li>
                        ...
                        <span className="text-muted">
                          <del>$5.00</del>{" "}
                          <span className="text-danger">$3.50</span>
                        </span>
                      </li>
                      <li className="d-flex flex-wrap align-items-center">
                        <input
                        ...
                        <Link href="/product-detail-layout-01">
                          Retro Lace Up Sneakers
                        </Link>
                        <select
                          className="form-select product-form-select w-auto d-inline-block ps-2 pe-4 py-1 mx-2"
                          style={{
                            backgroundPosition: "right .5rem center",
                            backgroundSize: "12px 10px",
                          }}
                        >
                          <option value="uk2" defaultValue="UK 2">
                            UK 2
                          </option>
