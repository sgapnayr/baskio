...
const MainSlide = () => {
  ...
  return (
    <React.Fragment>
      <section
        className="Baskio-home-section type_slideshow type_carousel Baskio-medical Baskio-handmade overflow-hidden"
        dir="ltr"
      >
                ...
                <div className="row">
                  <div className="col-10 col-lg-4">
                    <div className="content">
                      <h5 className="fw-medium text-sea fs-18 mb-2">
                        {slide.title}
                      </h5>
                      <h1 className="fs-45 lh-base fw-normal mb-4">
                        {slide.subtitle}
                      </h1>
                      <Link
