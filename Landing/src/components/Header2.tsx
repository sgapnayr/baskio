    ...
    <div className="swiper-slide">
      <div className="topbar-product-card pb-3">
        <div
          ...
          onMouseEnter={() =>
            product.hoverImageUrl && setImageUrl(product.hoverImageUrl)
          }
...
const Header2 = () => {
  ...
  return (
    <React.Fragment>
      <MainModel />
      <div id="Baskio-section-header_top" className="demo" ref={headerRef}>
          ...
          <Container fluid>
            <Row className="py-2">
              ...
              <Col
                md={6}
                lg={4}
                className="header-text text-center fs-12 py-1 py-md-0"
              >
