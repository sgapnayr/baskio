  ...
  return (
    <React.Fragment>
      ...
      <div>
        {/* main */}
        <section
          className="position-relative Baskio-decor overflow-hidden"
            ...
            <div className="row">
              <div className="col-lg-12">
                ...
                <div className="position-absolute top-0 start-0 end-0 bottom-0 text-center py-5 d-flex align-items-center justify-content-center">
                  <div>
                    <h1 className="mx-3 decor-title  mb-4">
            ...
            <Row>
              <Col md={4}>
                <div className="d-flex">
                  <i
                    className="las la-life-ring text-muted"
                    style={{ fontSize: "40px" }}
                  ></i>
                  <div className="ms-2">
              ...
              <div className="col-md-4 my-4 my-md-0">
                <div className="d-flex">
                  <i
                    className="las la-sync-alt text-muted"
                    style={{ fontSize: "40px" }}
                  ></i>
                  <div className="ms-2">
              ...
              <Col md={4}>
                <div className="d-flex">
                  <i
                    className="las la-user-circle text-muted "
                    style={{ fontSize: "40px" }}
                  ></i>
                  <div className="ms-2">
          ...
          <Container>
            <div className="row g-2 g-lg-4">
              <Col md={4}>
                <Link
                  href="#!"
                  className="d-block position-relative cat_grid_item overflow-hidden mb-4"
                  style={{ height: "220px" }}
                >
                  <div
              ...
              <Col md={4}>
                ...
                >
                  <div
                    className="h-100 w-100 cat-grid-img"
                    style={{ backgroundImage: `url(${hiend.src})` }}
                  ></div>
                  <div className="cat-grid-button text-body">
            ...
            <div className="row justify-content-center py-4">
              <Col md={8} className="col-10 text-center">
                ...
                <span className="section-subtitle sub-title font-secondary fst-italic fs-16 text-muted ">
                  ...
                  designs, exclusive offers, inspiration and tips!{" "}
                </span>
