      ...
      <div className="col-lg-3 col-md-3 col-6 px-12">
        ...
        >
          <div className="position-relative overflow-hidden main">
            {trend.label && (
              <span
                className={`new-label ${trend.labelClass} text-white rounded-circle`}
              >
                {" "}
                {trend.label}{" "}
              </span>
            ...
            <Image
              src={isHovered ? trend.hoveredImageUrl : trend.imageUrl}
              alt=""
              className="img-fluid"
            />
            <OverlayTrigger
          ...
          <div className="mt-3">
            <h6 className="mb-1 fs-16 fw-semibold font-playfair">
              <Link href="/product-detail-layout-01" className="main_link_lima">
                {trend.name}
              </Link>
            </h6>
...
const NowTrending = () => {
  ...
  return (
    <React.Fragment>
      <section className="Baskio-cosmetics-trending-products pb-4">
        <Container>
