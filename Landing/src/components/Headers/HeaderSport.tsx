              ...
              <div className="d-none d-lg-block mx-auto">
                <ul className="navbar-nav mx-auto mb-2 mb-lg-0 sport-header">
                  <li className="nav-item dropdown dropdown-mega-xxl">
                    <span
                      className={`nav-link fs-14 text-uppercase fw-medium ${
                        showw === 1 ? "show" : ""
                      }`}
                  ...
                  <li className="nav-item dropdown dropdown-mega-xxl">
                    <span
                      className={`nav-link fs-14 text-uppercase fw-medium position-relative ${
                        showw === 2 ? "show" : ""
                      }`}
                      data-bs-toggle="dropdown"
                      aria-expanded="false"
                            ...
                            <div className="swiper-wrapper">
                              {SportSaleSwiper.map((product: any) => (
                                <SwiperSlide key={product.id}>
                                  <HeaderCard
                                    product={product}
                                    handleOuickShow={handleOuickShow}
                                    handleAddToCardModalShow={
                                      handleAddToCardModalShow
                                    }
                                  />
