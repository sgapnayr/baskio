...
const HappyCustomer = () => {
  return (
    <React.Fragment>
      <section className="Baskio-furniture-testimonial">
        <div className="container">
          ...
          <div className="quotes_wrapper row g-0">
            <div className="col-lg-4 col-md-6">
              <div className="quote_slide border">
                <p className="text-muted fs-16">
                  ...
                  nicely setup. Support team is very responsive to problems.
                  Highly recommended to everyone! I’m your fan already
                </p>
                <div className="d-flex align-items-center gap-4 mt-4 pt-2">
                  <Image
                    src={customer1}
                    alt=""
                    className="square-md rounded-circle"
                  />
                  <div>
                    <h6 className="quote_author mb-0 text-uppercase">
                      ARTHUR HANSEN
                    </h6>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="quote_slide border">
                <p className="text-muted fs-16">
                  What an amazing theme and customer support!!! I knew I chose
                  well with you, guys!! I am not a developer, I just adjust
                  things I can manage, but everything was so easy customizing
                  the theme.
                </p>
                <div className="d-flex align-items-center gap-4 mt-4 pt-2">
                  <Image
            ...
            <div className="col-lg-4 col-md-6">
              <div className="quote_slide border">
                <p className="text-muted fs-16">
                  Octopus templates are awesome and very contemporary. They are
                  super sleek and fast. The best is the customer support.
                  Usually response is less than 30 minutes. Love it.
                </p>
                <div className="d-flex align-items-center gap-4 mt-4 pt-2">
                  <Image
                    src={customer3}
