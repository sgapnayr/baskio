        ...
        >
          ...
          <div className="mt-3">
            ...
            <p className="mb-0 fs-14 text-muted">
              ...
              <span className={item.discountedPrice ? "text-danger" : ""}>
...
const FeaturedCollection = () => {
  return (
    <React.Fragment>
      <section className="type_tab_collection Baskio-glasses-tab-product">
        <Container>
          ...
          <div className="mb-4">
            <Tab.Container
              ...
              defaultActiveKey="accessories-tab"
            >
              <Nav className="tab_header gap-lg-4 justify-content-center mt-4 mb-0">
                <Nav.Item role="presentation">
                  <Nav.Link eventKey="accessories-tab" className="rounded-pill">
                    Accessories
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item role="presentation">
                  <Nav.Link eventKey="smart-tv-tab" className="rounded-pill">
                    Smart TV
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item role="presentation">
                  <Nav.Link eventKey="camera-tab" className="rounded-pill">
                    Camera
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item role="presentation">
                  <Nav.Link eventKey="digital-tab" className="rounded-pill">
                    Digital
                  </Nav.Link>
                </Nav.Item>
              </Nav>
