...
const Products = () => {
  ...
  return (
    <React.Fragment>
      <section className="type_tab_collection Baskio-glasses-tab-product pb-4">
        <Container>
            ...
            <Col lg={8}>
              <div className="text-center">
                ...
                <p className="fs-14 text-muted mt-2 mb-0">
                  Eyeglasses teamed up to design a performance cycling frame
          ...
          <Tab.Container id="left-tabs-example" defaultActiveKey="#featured">
            <Nav
              className="nav nav-underline gap-4 nav-mustard justify-content-center mt-4 mb-0"
              id="pills-tab"
            >
              <Nav.Item>
                <Nav.Link
                      ...
                      <div className="mt-3 text-center">
                        ...
                        <div className="product-button d-none d-lg-flex flex-column gap-2">
                          <Link
                            ...
                            className="btn bg-mustard text-white fs-14"
                          >
                          ...
                          <button
                            type="button"
                            className="btn bg-mustard fs-14 text-white"
                            data-bs-toggle="modal"
                        ...
                        <div
                          className="position-absolute d-lg-none bottom-0 end-0 d-flex flex-column bg-mustard m-2"
                          style={{ zIndex: "1" }}
                        >
                          <Link
                            href="#exampleModal"
                          ...
                          <button
                            type="button"
                            className="btn responsive-cart bg-mustard  fs-14 p-2"
                            style={{ width: "36px", height: "36px" }}
                            data-bs-toggle="modal"
                            data-bs-target="#cardModal"
                            onClick={handleAddToCardModalShow}
