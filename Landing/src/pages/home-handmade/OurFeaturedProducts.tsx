            ...
            <div className="col-lg-7">
              <div className="text-center mb-4">
                ...
                <span className="fs-14 text-muted">
                  Don&apos;t miss any featured product by categories.
                </span>
              </div>
            </div>
          </div>
          <div className="mb-4 pb-2">
            ...
            >
              <Nav className="tab_header gap-md-4 justify-content-center mt-4 mb-0">
                ...
                <Nav.Item role="presentation">
                  <Nav.Link eventKey="kids_babies-tab" className="rounded-pill">
                    Kids &_Babies
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item role="presentation">
                  <Nav.Link
                    eventKey="kniting_sewing-tab"
                ...
                <Nav.Item role="presentation">
                  <Nav.Link eventKey="toys-tab" className="rounded-pill">
                    Toys
                  </Nav.Link>
                </Nav.Item>
              </Nav>
