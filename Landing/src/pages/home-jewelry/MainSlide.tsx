...
const MainSlide = () => {
  ...
  return (
    <React.Fragment>
      <section className="Baskio-home-section type_slideshow type_carousel Baskio-medical Baskio-jewelry-home overflow-hidden min-vh-100">
              ...
              <div className="row">
                <div className="col-lg-8">
                  <div className="content text-white">
                    <h5 className="fw-medium fs-18 mb-2">
                      A must-have for any jewellery box
                    </h5>
                    <h1 className="fs-50 fw-semibold mb-4">
                      70% OFF NEW COLLECTIONS
                    </h1>
                    <Link
              ...
              <div className="row justify-content-center">
                <div className="col-lg-8">
                  <div className="content text-center text-white">
                    <h5 className="fw-medium fs-18 mb-2">
                      Autumn-Spring Collections
                    </h5>
                    <h1 className="fs-50 fw-semibold mb-4">
                      WEDDING SEASON 50% OFF
                    </h1>
                    <Link
                      className="btn btn-dark rounded-0 min-w-150 min-h-45 d-inline-flex align-items-center justify-content-center fw-semibold px-4"
                      href="/shop"
