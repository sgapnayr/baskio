...
const HomeSection = () => {
  return (
    <React.Fragment>
      <section
        className="Baskio-banner-parallax-layout-01 min-vh-100 position-relative"
        style={{
          backgroundImage: `url(${lookbook.src})`,
      ...
      >
        <div className="position-absolute top-50 start-50 translate-middle text-white text-center my-5">
          ...
          <h3 className="fs-18 font-secondary fst-italic">
            Spring Collection 2021
          </h3>
          <Link
            href="/shop"
            className="btn btn-custom-white text-white min-w-150 rounded-pill mt-4"
          >
            Shop Now
          </Link>
        </div>
