                ...
                <Tab.Content className="mt-5">
                  <Tab.Pane eventKey="Description">
                    <Row className="pt-3">
                      <Col lg={6} className="text-center text-muted">
                        <h5 className="fw-semibold text-center mb-3 text-black">
                          FIGHTING FIT
                        </h5>
                        <p>
                          Go sporty this summer with this vintage navy and white
                          striped v-neck t-shirt from the Abercrombie & Fitch.
                          Perfect for pairing with denim and white kicks for a
                          stylish sporty vibe. Will fit a UK 8-10, model shown
                          is a UK 8 and 5’5. !!
                        </p>
                        <p>
                          ...
                          now—anyone who arranges words, letters, numbers, and
                          symbols for publication, display, or distribution—from
                          clerical workers and newsletter writers to anyone
                          self-publishing materials.
                        </p>
                        <p>
                          Hit your next boxing workout with a combination it’s
                          never seen before in the Combat Drop Arm Tank,
                          including a freedom-instilling regular fit and dropped
                          armhole to allow you to throw jabs and hooks at the
                          punching bag with ease. A lightweight material keeps
                        ...
                        <table className="table table-bordered">
                          <thead>
                            <tr>
                              <th
                                scope="col"
                                className="bg-transparent bg-muted fw-medium"
                              >
                                SIZE
                              </th>
                              <th
                  ...
                  <Tab.Pane eventKey="Warrantyshipping">
                    ...
                    <p className="mb-0">
                      ...
                      inherent flaw in the product, RAEN provides a 365 day
                      warranty from the time of purchase. If you feel your
                    ...
                    <p className="mb-4">
                      Free FedEx 2-Day Shipping is available exclusively to the
                      U.S. on orders over $150. FedEx 2-Day packages are
                      delivered Monday through Friday.
                    </p>
                    <h6 className="fw-bold">Free FedEx Ground Shipping</h6>
                    <p className="mb-4">
                      Free FedEx Ground Shipping is available exclusively to
                      U.S. orders over $100.
                    </p>
                    <h6 className="fw-bold">Free Returns</h6>
                    <p className="mb-4">
                      Free returns are available on all U.S. order within 14
                      days of shipment.
                    </p>
                    <p className="fst-italic fw-medium">
                      *Free Shipping is not available with some promotions and
