...
const OurStory = () => {
  ...
  return (
    <React.Fragment>
      <section className="Baskio-lingerie-main">
        <Container>
          <Row className="justify-content-center">
            <Col lg={9}>
              <div className="text-center">
                ...
                <p className="fs-14 text-muted mb-3 pb-2">
                  When you think of swimwear, you likely don’t think about high
                  necklines. After all, most styles are swooping so low in the
                  front that they’re absolutely impossible to wear if you have a
                  large bust. But don’t be mistaken – high neckline bikini tops
                  are all the rage right now, and they’re super chic!
                </p>
                <Link
            ...
            <Col md={6}>
              <div className="position-relative">
                ...
                <div className="pin-type position-absolute position-05">
                  ...
                  <Link
                    href="#pinType8"
                    className="bg-dark text-white rounded-circle d-flex align-items-center justify-content-center position-relative"
                    onClick={handleShow}
                  >
        ...
        <Modal
          ...
          onHide={handleClose}
          centered
          className="fade modal-overl pin_popup"
          id="pinType8"
        >
            ...
            >
              <div className="position-relative overflow-hidden">
                ...
                >
                  <Button
                    variant="link"
                    className="wishlistadd position-absolute d-lg-none"
                ...
                >
                  <Button
                    variant="link"
                    className="wishlistadd position-absolute d-none d-lg-flex"
                  >
                    <i className="facl facl-heart-o text-white"></i>
                  </Button>
                </OverlayTrigger>
              ...
              <div className="mt-3 text-center">
                ...
                <div className="product-color-list mt-2 gap-2 d-flex align-items-center justify-content-center">
                  <Link
                    href="#!"
                    onClick={() => handleImageChange(pr2)}
                    className="d-inline-block bg-dark rounded-circle"
                  ></Link>
                  <Link
                    href="#!"
                    onClick={() => handleImageChange(pr3)}
