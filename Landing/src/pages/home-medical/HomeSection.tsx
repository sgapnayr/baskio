...
const HomeSection = () => {
  ...
  return (
    <React.Fragment>
      <section className="Baskio-home-section type_slideshow type_carousel Baskio-medical overflow-hidden">
              ...
              <Row>
                <Col lg={4}>
                  <div className="content">
                    <h5 className="text-danger-emphasis fw-medium fs-22">
                      3M 6000 Series
                    </h5>
                    <h1 className="fs-45 fw-semibold mb-3 ">
                      Search Lab <br /> N95 Face Mask
                    </h1>
                    <p className="d-none d-lg-block">
                      respiratory protection against certain non oil based
                      particles.{" "}
                    </p>
                    <Link href="/shop">
            ...
            <div className="container position-relative">
              <Row>
                <Col lg={4}>
                  <div className="content">
                    <h5 className="text-danger-emphasis fw-medium fs-22">
                      Price just <strong>$14</strong>
                    </h5>
                    <h1 className="fs-45 fw-semibold mb-3">
                      Botanical Hand <br /> Sanitizer Gel
                    </h1>
                    <p className="fs-16 text-muted d-none d-lg-block ">
                      Soft and non-irritating, does not hurt the skin, has a
                      water retention and hydration function
                    </p>
                    <Link href="/shop">
              ...
              <Row>
                <Col lg={4}>
                  <div className="content">
                    ...
                    <p className="fs-16 text-muted d-none d-lg-block">
                      In 3 seconds, you&apos;ll get the exact number of your
                      body&apos;s temperature. Suitable for both baby & adult
                    </p>
                    <Link href="/shop">
