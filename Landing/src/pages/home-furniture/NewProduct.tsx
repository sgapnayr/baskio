...
const NewProduct = () => {
  ...
  return (
    <React.Fragment>
      <section className="Baskio-furnitur-featured-collection position-relative">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="text-center wrap_title position-relative">
                <h3 className="font-roboto-slab mb-3 fw-light fs-35 pb-1">
                  New Products
                </h3>
                <p className="fs-16 text-muted mb-5">
                  Update your space with new finds in dining furniture, bedroom
                  sets, living room sofas and chairs, and accent tables from
                  around the world
                </p>
              </div>
            </div>
                ...
                <div className="text-start mt-3">
                  <h6 className="mb-2 fw-medium">
                    <Link
                      ...
                      className="main_link_warning fs-18"
                    >
                      Flow Table Lamp EU Spainmboo Chair
                    </Link>
                  </h6>
                  <p className="mb-0 fs-16 text-muted">
                    <span>$110.00</span>
