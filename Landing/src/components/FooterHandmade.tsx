...
import Baskio from "@assets/images/svg/kalles.svg";
      ...
      <footer className="footer footer-handmade">
        <Container>
          <div className="row accordion" id="footer-accordion">
            ...
            >
              <button
                className={`accordion-button footer-accordion-button ${
                  open === 1 ? "" : " collapsed"
                } px-0`}
                type="button"
              ...
              >
                <Link href="#!">
                  <Image src={Baskio} alt="" height="29" />
                </Link>
                ...
                <div className="mt-md-4 pt-md-2">
                  <ul className="menu list-unstyled">
                    <li className="menu-item">
                      <Link href="/shop-filter-sidebar" className="text-black">
                        Men
                      </Link>
                    </li>
                    <li className="menu-item">
                    ...
                    <li className="menu-item">
                      <Link href="/shop-1600px-layout" className="text-black">
                        Accessories
                      </Link>
                    </li>
                    <li className="menu-item">
        ...
        <Container>
          <Row>
            <Col sm={6} className="text-center mb-1">
              Copyright © {year}
              <Link href="#!" className="text-reset fw-semibold">
                {" "}
                Baskio
              </Link>{" "}
            ...
            <Col sm={6}>
              <ul
                id="footer-menu"
                className="list-unstyled d-flex align-items-center mb-0 justify-content-end"
              >
                <li className="menu-item ">
