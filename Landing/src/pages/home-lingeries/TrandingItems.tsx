...
const TrandingItems = () => {
  return (
    <React.Fragment>
      <div className="Baskio-lingerie-banner-trending position-relative">
        <Container>
          <Row className="g-0">
                ...
                <div className="text-center position-absolute top-0 start-0 end-0 bottom-0 d-flex align-items-center justify-content-center mx-5">
                  <div>
                    ...
                    <p className="fs-14 text-muted mb-3">
                      Where many swim lines have their place in the sun, Baskio
                      transcends beach and the pool. The pieces transition
                      seamlessly as day or evening Ready-to-Wear, providing an
                      innate versatility your already established wardrobe.
                    </p>
                    <Link
