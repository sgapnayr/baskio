                  ...
                  <div className="col-12">
                    <ul className="list-unstyled m-0 p-0 vstack gap-3">
                      <li className="d-flex flex-wrap align-items-center">
                        ...
                        <select
                          className="form-select w-auto d-inline-block ps-2 pe-4 py-1 mx-2 rounded-1"
                          style={{
                      ...
                      <li className="d-flex flex-wrap align-items-center">
                        ...
                        <select
                          className="form-select product-form-select w-auto d-inline-block ps-2 pe-4 py-1 mx-2 rounded-1"
                          style={{
                            backgroundPosition: "right .5rem center",
                            backgroundSize: "12px 10px",
                          }}
