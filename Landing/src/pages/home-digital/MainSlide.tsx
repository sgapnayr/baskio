...
const MainSlide = () => {
  ...
  return (
    <React.Fragment>
      <section
        className="Baskio-home-section type_slideshow type_carousel Baskio-medical Baskio-digital overflow-hidden"
        dir="ltr"
      >
        <div
          className="slideshow"
        ...
        >
          <div className="slideshow__slide">
            <Image
              src={mainslide}
              alt=""
              className="d-none d-md-block position-absolute w-100 h-100 object-fit-cover"
            />
              ...
              <div className="row">
                <div className="col-lg-7">
                  <div className="content text-center text-sm-start">
                    ...
                    <h5 className="mb-4 fs-22">
                      This is the phone that will change photography
                    </h5>
                    <Link
                      className="btn btn-dark text-white rounded-pill min-w-150 min-h-45 d-inline-flex align-items-center justify-content-center fw-semibold px-4"
                      href="/shop"
                    >
                      Explore Now
                    </Link>
              ...
              <div className="row">
                <div className="col-lg-7">
                  <div className="content">
                    <h5 className="fw-medium fs-18 mb-2">SUMMER 2024</h5>
                    <h1 className="fs-55 lh-base mb-1">
                      Meet Galaxy S20, S20+
                    </h1>
                    <h5 className="mb-4 fs-22">
                      This is the phone that will change photography
