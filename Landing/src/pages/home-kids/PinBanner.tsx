    ...
    <React.Fragment>
      <section className="home-kids-pin">
        <div className="container-fluid px-0">
          <div
            className="w-100 Baskio-lookbook-home position-relative"
          ...
          >
            <div className="pin-type position-absolute position-01">
              ...
              <Link
                href="#pinType1"
                className="bg-blue-dark text-white rounded-circle d-flex align-items-center justify-content-center position-relative"
                data-bs-toggle="modal"
                onClick={handleKisdModelShow}
              >
