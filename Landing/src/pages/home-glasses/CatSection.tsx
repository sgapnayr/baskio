...
const CatSection = () => {
  return (
    <React.Fragment>
      <div className="banner-section Baskio-glasses-banner-double-cat position-relative py-4 mt-2">
        <Container>
          <Row className="g-4">
            <Col lg={6}>
              <Link
              ...
              >
                ...
                <div className="nt_promotion_html position-absolute">
                  <div className="text-end">
                    <h4 className="fs-28 font-pinyon-script text-mustard ls-1">
                      The classic aviator
                    </h4>
                    <h6 className="mb-0 fs-32 text-body font-montserrat">
                      MEN’S EYEWEAR <br /> ORIGINALS
                    </h6>
                  </div>
                </div>
              </Link>
