...
const productData = [
  ...
  },
  {
    ...
    rating: 3,
    reviews: 4,
    colors: [blue, line, nude, grey, line, blue],
  },
];
const productData2 = [
  {
      ...
      <div className="col-6 col-lg-3">
        <div className="topbar-product-card desgin_1 bg-muted">
          <div className="position-relative overflow-hidden">
            {product.discount && (
              <span className="new-label bg-blue-dark text-white rounded-circle">
                {product.discount}
              </span>
            )}
            <Image
            ...
            <div className="product-button d-none d-lg-flex flex-column gap-2">
              ...
              <button
                type="button"
                className="btn rounded-pill fs-14 text-black"
                data-bs-toggle="modal"
            ...
            <div
              className="product2-button position-absolute d-lg-none bottom-0 end-0 d-flex flex-column bg-white rounded-pill m-2"
              style={{ zIndex: 1 }}
            >
              <Link
                href="#exampleModal"
          ...
          <div className="my-3">
            <h6 className="fs-16 fw-medium mb-1">
              <Link
                className="main_link_primary font-futura text-blue-dark"
              ...
              <span className="Baskio-rating-result__pipe">
                {Array(5)
                  ...
                  .map((_, i) => (
                    <span
                      key={i}
                      className={`Baskio-rating-result__start ${
                        i < product.rating ? "active" : ""
                      }`}
                    ></span>
                  ))}
              </span>
              <span className="Baskio-rating-result__number text-muted">
                ({product.reviews})
              </span>
            </div>
          </div>
          {product.colors && (
            <div className="product-color-list mt-2 gap-2 d-flex align-items-center">
              {product.colors.map(
                (color: any, i: React.Key | null | undefined) => (
                  <Link
                    key={i}
                    href="#!"
                    onMouseOver={() => setImageUrl(color)}
              ...
              <div className="text-center">
                <div className="mt-3">
                  ...
                  <p className="m-0 text-muted">
                    Buy High Quality Products To Ensure The Best Quality For
                    Your Health
                  </p>
                </div>
              </div>
          ...
          <div className="pt-4">
            ...
            >
              <Nav className="tab_header gap-lg-2 justify-content-center mt-4 mb-0">
                ...
                <Nav.Item role="presentation">
                  <Nav.Link eventKey="featured" className="rounded-pill">
                    Featured
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item role="presentation">
                  <Nav.Link eventKey="sale" className="rounded-pill">
                    Sale
                  </Nav.Link>
                </Nav.Item>
              </Nav>
