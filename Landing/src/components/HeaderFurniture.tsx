...
import {
  ...
  ProductFeatures,
  swiperdata,
} from "@src/common/Header/headerfurniture";
    ...
    <React.Fragment>
      <div className="topbar-product-card pb-3">
        <div className="position-relative overflow-hidden">
          {item.sale && (
            <span className="onsale position-absolute bg-danger text-white d-flex align-items-center justify-content-center">
              {item.sale}
            </span>
          )}
        ...
        <div className="mt-3">
          <h6 className="mb-2 fw-medium">
            <Link
              ...
              className="main_link_warning fs-18"
            >
              {item.name}
            </Link>
          </h6>
          <p className="mb-0 fs-16 text-muted">
            ...
            <span className={item.oldPrice ? "text-warning" : ""}>
              {item.price}
            </span>
          </p>
        </div>
...
const HeaderFurniture = () => {
  ...
  return (
    <React.Fragment>
      <MainModel />
      <div
        id="Baskio-section-header_top bg-white"
        className="furniture-header demo"
        ref={headerRef}
      >
            ...
            <Row className="align-items-center py-2 py-lg-0">
              <Col lg={4}>
                <div className="d-flex align-items-center justify-content-center justify-content-lg-start gap-3">
                  <p className="mb-0">
                    <i className="pegk pe-7s-call fs-14 me-1 align-middle text-warning"></i>{" "}
                    +01 23456789
                  </p>
                  <p className="mb-0">
                    <i className="pe-7s-mail pegk fs-14 me-1 align-middle text-warning"></i>{" "}
                    Baskio@domain.com
                  </p>
                </div>
              </Col>
              <Col lg={4}>
                <div className="header-text text-center fs-12">
                  ...
                  <span className="cr text-warning">50%</span>!{" "}
              ...
              <Col lg={4}>
                <Dropdown className="text-lg-end text-center position-relative">
                  ...
                  >
                    <Image src={USD} alt="" height="12" className="me-1" /> USD{" "}
                    <i className="facl facl-angle-down ms-1"></i>
                  </Dropdown.Toggle>
        ...
        <nav
          className={`navbar navbar-expand-lg navbar-custom py-0 d-flex align-items-center bg-white px-lg-3 ${
          ...
          <div className="container-fluid">
              ...
              <div className="d-none d-lg-block mx-auto">
                <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                  <li className="nav-item dropdown dropdown-mega-xxl">
                    ...
                    <div
                      className={`dropdown-menu ${show === 1 ? "show" : ""}`}
                    >
                      <Row>
                        <Col lg={3}>
                  ...
                  <li className="nav-item dropdown dropdown-mega-3xl">
                    ...
                    <div
                      className={`dropdown-menu ${show === 4 ? "show" : ""}`}
                    >
                      <Row>
                        <Col lg={12}>
                          <Swiper
                  ...
                  <li className="nav-item dropdown dropdown-mega-lg">
                    <Link
                      className={`nav-link ${show === 5 ? "show" : ""}`}
                      href="#"
                      role="button"
                      data-bs-toggle="dropdown"
                      aria-expanded="false"
                  ...
                  <li className="nav-item dropdown dropdown-mega-lg">
                    <Link
                      className={`nav-link ${show === 6 ? "show" : ""}`}
                      href="#"
                      role="button"
                      data-bs-toggle="dropdown"
                      aria-expanded="false"
            ...
            <div className="topbar-toolbar d-flex align-items-center gap-3">
              <Link
                ...
                onClick={handleShow}
              >
                <i className="iccl iccl-search fw-bold"></i>
              </Link>
              <Link
              ...
              >
                <i className="iccl iccl-user fw-bold"></i>
              </Link>
              <Link href="/wishlist">
                <i className="iccl iccl-heart fw-bold"></i>
                <span className="tcount bg-warning text-white rounded-circle d-flex align-items-center justify-content-center">
                  3
                </span>
              </Link>
              <Link
              ...
              >
                <i className="iccl iccl-cart fw-bold"></i>
                <span className="tcount bg-warning text-white rounded-circle d-flex align-items-center justify-content-center">
                  5
                </span>
              </Link>
