  ...
  return (
    <React.Fragment>
      ...
      <div>
        ...
        {/* delay */}
        <section className="Baskio-handmade-banner mt-5">
          <Container>
            <Row>
              <Col lg={6}>
        ...
        <section className="pt-5">
          <Container>
            <div className="bg-light px-4 py-5">
              <Row>
                <Col lg={4}>
                  <h1 className="font-marcellus fw-medium fs-45 lh-base">
                    The difference when you shop Baskio!
                  </h1>
                </Col>
                <Col lg={4} className="my-4 mb-lg-0">
                  <div className="mb-4">
                    <h3 className="font-avenir fw-semibold fs-22">
                      Superb Quality
                    </h3>
                    <p className="fs-16 mb-0">
                      We make commitments that the quality of our products will
                      and always will be superb.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-avenir fw-semibold fs-22">
                    ...
                    <p className="fs-16 mb-0">
                      We accept returns for freshly purchased products within 7
                      days from the payment.
                    </p>
                  </div>
                </Col>
                <Col lg={4}>
                  <div className="mb-4 pb-2">
                    ...
                    <p className="fs-16 mb-0">
                      Upon request, items bought as gifts from our store can
                      receive free wrapping service.{" "}
                    </p>
                  </div>
                  <div>
                    <h3 className="font-avenir fw-semibold fs-22">
                    ...
                    <p className="fs-16 mb-0">
                      Once receiving your order, we will turn your products
