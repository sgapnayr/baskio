                    ...
                    <Row className="equal_nt nt_contain">
                      <Col lg={4} className="mb-3 mb-lg-0">
                        ...
                        <p>
                          ...
                          tortor adipiscing ullamcorper etiam imperdiet pulvinar
                          vel facilisis potenti facilisis mi parturient sed per
                          egestas vivamus a auctor eu curae. Id dui bibendum non
                          enim accumsan leo habitant diam eu.
                        </p>
