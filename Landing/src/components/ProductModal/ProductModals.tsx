      ...
      >
        <Modal.Body className="p-20">
          ...
          <div className=" container p-5">
            <div className="row">
              <div className="col-md-6">
                <div>
                  ...
                  <p>
                    Please be aware that most of our clothing is Juniors&apos;
                    sizing, which runs smaller than regular US / European Women
                    sizing. Refer to the measurements chart for each individual
                    product to determine the best size for you. Product specific
                    size chart and information can be found in product
                    description or in product picture gallery.
                  </p>
                  <p>
                    Our team does it&apos;s best to include accurate size
                    details and measurement of each item in the product
                    descriptions. If you have questions regarding sizing or any
                    other information on a specific item, please email us at
                    hello@Baskio.com for specific details.
                  </p>
                </div>
              </div>
              <div className="col-md-6">
                <div>
                  ...
                  <p>
                    When comparing your measurements to those listed on the
                    site, make sure to check if the fabric is stretchy or not.
                    If it is, it can stretch an inch or more.
                  </p>
                  <ul className="p-0 ps-3 mb-0">
                    <li>
                      <strong> Bust:</strong> Wrap the measuring tape loosely
                      around the fullest part of your bust to ensure a
                      comfortable fit.
                    </li>
                    <li>
                      <strong>Waist:</strong> Measure the narrowest part of your
                      natural waist, holding the measuring tape loose enough to
                      fit comfortably.
                    </li>
                    <li>
                      <strong>Hips:</strong> Drape the measuring tape around the
                      widest part of your hips, resting the tape comfortably
                      against your body.
                    </li>
                    <li>
                      <strong>Length:</strong> For tops and dresses, measure
                      from the top of your shoulder to the hem. For strapless
                      dresses, measure from the highest part of the neckline to
                      the hem. For pants and skirts, measure from the top of the
                      waist to the hem.
                    </li>
                    <li>
                      <strong>Sleeve:</strong> With your arm outstretched,
                      measure from the base of your neck to the end of the
                      sleeve hem to determine where the sleeve length will fall
                      on you.
                    </li>
                  </ul>
                </div>
            ...
            <Tabs
              defaultActiveKey="dresses"
              id="size-chart-tabs"
              className="mb-3 justify-content-center product-tabs"
            >
                        ...
                        <thead>
                          <tr>
                            <th colSpan={5} className="text-center fw-medium">
                              DRESSES <br />{" "}
                              <span className="fw-light">SIZE IN INCHES</span>
                            </th>
                          </tr>
                          <tr>
                      ...
                      <table className="table table-bordered table-striped w-100">
                        <thead>
                          <tr>
                            <th colSpan={5} className="text-center fw-medium">
                              DRESSES <br />{" "}
                              <span className="fw-light">SIZE IN CM</span>
                            </th>
                          </tr>
                          <tr>
                            <td className="text-center">SIZE</td>
            ...
            <p className="mt-4">
              <b>Attention:</b> This guide provides general sizing information
              only, and fit can vary depending on style and brand. For more
              specific sizing information on the product, please refer to
              product description.
            </p>
            ...
            <ul className="p-0 ps-3">
              <li>
                All Baskio models are wearing size small in tops and dresses,
                and size 1, 3, or 5 in jeans depending on their body type.
              </li>
              <li>
                Most Baskio jeans &amp; dresses have some stretch, please refer
                to product description for fabric details.
              </li>
              <li>
                Most Baskio bottoms have an inseam of 31-34” depending on the
                cut and style. Sizing may vary depending on cut and style.
              </li>
            </ul>
            <br />
  ...
  return (
    <React.Fragment>
      <Modal
        ...
        onHide={handleClose3}
        centered
        className="modal-overl modal-md"
      >
        <Modal.Body>
          <div className="text-end position-fixed top-0 end-0">
            <button
          ...
          <div className="p-4">
            <form method="" action="#">
              ...
              <p>
                <label htmlFor="ContactFormAsk-name" className="form-label">
                  Your Name
                </label>
                <input
                  type="text"
                  className="form-control"
                  id="ContactFormAsk-name"
                  name="name"
              ...
              <p>
                <label htmlFor="ContactFormAsk-email" className="form-label">
                  Your Email
                </label>
                <input
                  type="email"
              ...
              <p>
                <label htmlFor="ContactFormAsk-phone" className="form-label">
                  Your Phone Number
                </label>
                <input
                  type="tel"
                  className="form-control"
                  id="ContactFormAsk-phone"
                  name="phone"
                  pattern="[0-9\-]*"
                  placeholder="91-854263169"
                />
              </p>
              <p>
                <label htmlFor="ContactFormAsk-message" className="form-label">
                  Your Message
                </label>
                <textarea
                  rows={8}
                  className="form-control"
                  id="ContactFormAsk-message"
                  name="body"
