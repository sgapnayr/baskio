    ...
    >
      ...
      <div className="mt-3">
        <h6 className="mb-1 fs-16 fw-medium font-avenir">
          <Link href="/product-detail-layout-01" className="text-reset">
            {product.name}
          </Link>
        </h6>
...
const HandmadeHeader = () => {
  ...
  return (
    <React.Fragment>
      <div id="Baskio-section-header_top" className="navbar-handmade">
        ...
        <nav
          className={`navbar navbar-expand-lg navbar-custom py-0 d-flex align-items-center demo ${
        ...
        >
          <div className="container">
            ...
            <Link className="navbar-brand fs-14 d-none d-lg-block" href="#">
              Welcome to our store!
            </Link>
            <Link className="navbar-brand d-lg-none nav-link" href="#">
              ...
              <div className="d-none d-lg-block mx-auto">
                <ul className="navbar-nav mx-auto mb-2 mb-lg-0 lingeries-header">
                                ...
                                (item: any, index: number) => {
                                  return (
                                    <li key={index}>
                                      ...
                                      >
                                        {item.lable}
                                        <span className={item.badgeColor2}>
                                          {item.badge2}
                                        </span>
                                      </Link>
                                    </li>
                  ...
                  <li className="nav-item">
                    <Link className="navbar-brand nav-link" href="/index">
                      <Image src={logo} alt="" width="95" />
                    </Link>
                  </li>
                              ...
                              {HandmadesaleSwiper.map((product: any) => (
                                <SwiperSlide key={product.id}>
                                  <div>
                                    <ProductCard
                                      product={product}
                                      handleQulickShow={handleQulickShow}
                                      handleAddToCardModalShow={
                                        handleAddToCardModalShow
                                      }
                                    />
            ...
            <div className="topbar-toolbar d-flex align-items-center gap-3 lingeries-header">
              ...
              <Link className="d-md-block d-none" href="/wishlist">
                ...
                <span className="tcount bg-danger text-white rounded-circle d-flex align-items-center justify-content-center">
                  3
                </span>
              </Link>
              <Link
