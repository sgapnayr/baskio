        ...
        <div className="container">
          <div className="row accordion" id="footer-accordion">
            <div className="col-md-6 col-lg-4 mb-0 footer-accordion-item accordion-item">
              <button
                className={`accordion-button footer-accordion-button  text-white px-0 ${
                  open === 1 ? "" : "collapsed"
                }`}
                type="button"
            ...
            <div className="col-md-6 col-lg-2 mb-0 accordion-item footer-accordion-item">
              <button
                className={`accordion-button footer-accordion-button px-0 py-3  ${
                  open === 2 ? "" : "collapsed"
                }`}
                type="button"
                data-bs-toggle="collapse"
                  ...
                  <form id="contact_form" className="d-block">
                    <div className="footer-subscribe position-relative">
                      <input
                        ...
                        className="border-dark input-text form-control w-100 rounded-0 placeholder-white"
                        required
                      />
                      <button
                        type="submit"
                        className="btn btn-dark bg-mustard position-absolute rounded-0 top-0 end-0 h-100"
                      >
                        <span>Subscribe</span>
                      </button>
                    </div>
        ...
        <Container>
          <Row className="text-center text-lg-start">
            ...
            <Col lg={6} className="mt-2 mt-sm-0  d-flex justify-content-center">
              <ul
                id="footer-menu"
                className="list-unstyled d-flex align-items-center mb-0 justify-content-md-end"
              >
                <li className="menu-item ">
                  <Link href="/shop-filter-sidebar" className="text-white mx-2">
                    Shop
                  </Link>
                </li>
                <li className="menu-item ">
