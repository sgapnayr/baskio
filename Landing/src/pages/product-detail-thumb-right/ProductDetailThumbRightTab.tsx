...
import {
  ...
  FashionModall,
  SortModal,
} from "@src/components/ProductDetailThumbRightModals/ProductDetailThumbTabModal";
  ...
  return (
    <React.Fragment>
                ...
                <Tab.Content className="mt-5">
                  <Tab.Pane eventKey="Description">
                    <p className="text-black">
                      ...
                      id velit vitae ligula volutpat condimentum. Aliquam erat
                      volutpat. Sed quis velit. Nulla facilisi. Nulla libero.
                      Vivamus pharetra posuere sapien. Nam consectetuer. Sed
                    ...
                    <div className="mt-5">
                      <div className="position-relative">
                        ...
                        <div className="pin-type position-absolute position-01">
                          ...
                          <Link
                            href="#pinType1"
                            className="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center position-relative"
                            data-bs-toggle="modal"
                            onClick={handleRightModal1Show}
                          >
                        ...
                        <div className="pin-type position-absolute position-02">
                          ...
                          <Link
                            href="#pinType2"
                            className="bg_color_red text-white rounded-circle d-flex align-items-center justify-content-center position-relative"
                            data-bs-toggle="modal"
                            onClick={handleRightModal2Show}
                          >
                            <i className="nav_link_icon position-relative"></i>
                          </Link>
                        </div>
      ...
      <HairMoadl
        ...
        handleRightModal1Close={handleRightModal1Close}
      />
      <FashionModal
        modalShow2={modalShow2}
        handleRightModal2Close={handleRightModal2Close}
      />
      <ProductInfoModal
        modalShow3={modalShow3}
        handleRightModal3Close={handleRightModal3Close}
      />
      <ProductHoverModal
        modalShow4={modalShow4}
        handleRightModal4Close={handleRightModal4Close}
      />
      <FashionModall
        modalShow5={modalShow5}
        handleRightModal5Close={handleRightModal5Close}
      />
      <SortModal
        modalShow6={modalShow6}
        handleRightModal6Close={handleRightModal6Close}
      />
    </React.Fragment>
  );
};
