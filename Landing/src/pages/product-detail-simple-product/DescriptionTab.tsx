                ...
                <Tab.Content className="mt-5">
                    ...
                    <Row className="align-items-center pt-5">
                      <Col md={3}>
                        <div className="text-center text-md-end d-md-flex flex-md-row-reverse align-items-center justify-md-content-end mb-5">
                          ...
                          <p className="me-2 mb-0 text-muted text-md-end">
                            Rain & Water
                            <br />
                            Resistant
                          </p>
                  ...
                  <Tab.Pane eventKey="Warrantyshipping">
                    ...
                    <p className="mb-0">
                      ...
                      <a href="#!">warranty@domain.com</a> explaining the nature
                      of your warranty claim and all necessary details.
                    </p>
                    <p className="mb-4">
