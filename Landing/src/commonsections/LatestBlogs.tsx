...
const LatestBlogs = () => {
  return (
    <React.Fragment>
      <section className="Baskio-section_type_featured_blog latest-blogs">
        <div className="container">
          ...
          <div
            className="row g-4 blog-arrow Baskio-blog-grid"
                ...
                >
                  <div className="blog_grid overflow-hidden">
                    <div
                      ...
                      style={{
                        background: `url(${item.pic.src}) center no-repeat`,
