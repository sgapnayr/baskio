          ...
          <div className="row g-lg-4 g-3 gy-md-0 gy-4 align-items-center">
            <div className="col-md-4">
              <Link
                ...
                className="position-relative hover-zoom d-flex promotion_banner"
              >
                <Image
                  src={bn1}
                  alt=""
                  className="img-fluid hover-zoom-img object-fit-cover"
                />
            ...
            <div className="col-md-4">
              <div className="Baskio-banner-promotion topbar-product-card">
                <div className="position-relative overflow-hidden">
                  ...
                  <div className="product-size text-center d-none d-lg-block">
                    ...
                    <div className="product-color-list mt-1 gap-2 d-flex align-items-center justify-content-center p-2">
                      <Link
                        href="#!"
                        onMouseOver={() => setImageUrl(big24)}
                        onClick={(e) => e.preventDefault()}
                        className="d-inline-block bg_color_pink rounded-circle"
                      ></Link>
                      <Link
                        href="#!"
                        onMouseOver={() => setImageUrl(big25)}
                        onClick={(e) => e.preventDefault()}
                ...
                <div className="d-lg-none">
                  ...
                  <div
                    className="count-time position-relative mt-4"
                    data-date="10-10-2028"
                  >
                    <ul className="list-unstyled d-flex gap-2 align-items-center text-center justify-content-center mb-0">
                      <li
            ...
            <div className="col-md-4">
              <Link
                href="/shop"
                className="position-relative hover-zoom d-flex promotion_banner Baskio-banner-promotion"
              >
                <Image
                  src={bn2}
                  alt=""
                ...
                <div className="p-20 position-absolute top-50 end-0 text-body start-0 content-position text-center">
                  ...
                  <button className="btn btn-custom-dark fw-medium min-w-150 rounded-pill">
                    Shop Now
                  </button>
                </div>
              </Link>
