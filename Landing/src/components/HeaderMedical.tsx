...
import {
  ...
  salesSwiper3,
  ShopPage3,
} from "@src/common/Header/headermedical";
...
import logo from "@assets/images/home-medical/Baskio-medical-170.png";
            ...
            <div className="row align-items-center align-items-md-start">
              ...
              <div className="col-xl-4 col-lg-5 col-12 col-md-12 d-none d-lg-block">
                <div className="header-text text-center fs-12">
                  <span className="badge d-inline-block fs-12 fw-normal">
                    COVID-19 UPDATE
                  </span>{" "}
              ...
              <div className="col-xl-4 col-lg-2 col-12 col-md-12 d-none d-lg-block">
                <div className="dropdown text-end position-relative">
                  ...
                  <ul
                    className={`dropdown-menu p-3 dropdown-currency ${
                      show === 8 ? "show drop" : ""
                    }`}
                  >
                    <li>
        ...
        >
          <Container>
            ...
            >
              <ul className="navbar-nav me-auto">
                ...
                <li className="nav-item dropdown dropdown-mega-xxl">
                  ...
                  <div
                    className={`dropdown-menu p-3 ${show === 2 ? "show" : ""}`}
                  >
                    <Row className="g-0">
                      <Col lg={5}>
                        <Row className="g-0">
                          ...
                          <div className="col-lg-6 cat-section p-0">
                            ...
                            >
                              <div
                                ...
                                style={{
                                  backgroundImage: `url(${promot1.src})`,
                                }}
                              ></div>
                            </Link>
                          </div>
                          <div className="col-lg-6 cat-section ps-4 p-0">
                            ...
                            >
                              <div
                                className="h-100 w-100 cat-grid-img"
                                style={{
                                  backgroundImage: `url(${promot2.src})`,
                                }}
                              ></div>
                            </Link>
                          </div>
                              ...
                              <SwiperSlide key={idx}>
                                <div className="img-zoom">
                                  <Link
                                    ...
                                    className="overflow-hidden d-inline-block"
                                  >
                                    <Image
                                      src={product.image}
                                      alt=""
            ...
            <div className="topbar-toolbar d-flex align-items-center gap-3">
              ...
              <form
                className="search_header position-relative d-none d-xl-block"
                role="search"
              >
                <input
                ...
                />
                <button
                  className="btn btn-link rounded-pill text-body"
                  type="submit"
                >
              ...
              >
                <i className="las la-user fs-28"></i>
              </Link>
              <Link href="#!">
                <i className="lar la-heart fs-28"></i>
                <span className="tcount bg-primary text-white rounded-circle d-flex align-items-center justify-content-center">
                  3
                </span>
              </Link>
              <Link
              ...
              >
                <i className="las la-shopping-cart fs-28"></i>
                <span className="tcount bg-primary text-white rounded-circle d-flex align-items-center justify-content-center">
                  5
                </span>
              </Link>
