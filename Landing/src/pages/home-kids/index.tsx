  ...
  return (
    <React.Fragment>
      ...
      <div className="home_kids_main">
        ...
        {/* main slide */}
        <div
          className="px-0 Baskio-home-section type_slideshow type_carousel Baskio-medical Baskio-bags kids-banner"
          dir="ltr"
        >
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="content">
                      <h5 className="text-blue fw-normal text-uppercase fs-14">
                        Free Shipping Available
                      </h5>
                      <h1 className="font-futura text-blue-dark mb-5">
                        BIG SAVE ON <br /> FASHION BONANSA
                      </h1>
                      <p className="mb-4">
                        Flannel lightweight line overall collection
                      </p>
                      <Link
                        href="#!"
                        className="btn btn-blue-dark text-white px-4 text-uppercase rounded-pill fw-semibold"
                      >
                        shop now
                      </Link>
                    </div>
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="content">
                      ...
                      <h1 className="font-futura fs-50 text-blue-dark mb-3">
                        BIG SAVE ON
                        <br /> FASHION BONANZA
                      </h1>
                      <h5 className="text-blue fw-normal fs-14 pb-3">
                        Lightweight collection of apparels now!
                      </h5>
                      <Link
                        href="#!"
                        className="btn btn-blue-dark text-white px-4 text-uppercase rounded-pill fw-semibold mt-4"
                      >
                        shop now
                      </Link>
                    </div>
              ...
              <Col lg={6}>
                <div className=" position-relative">
                  ...
                  <div className="position-absolute top-50 start-0 translate-middle-y mt-3 ms-2 ms-md-5">
                    <h6 className="fw-light d-none d-sm-block text-uppercase fs-13 fst-italic">
                      50% Discount available
                    </h6>
                    <h2 className="text-blue-dark text-uppercase fw-bold mb-1 mb-md-3">
                      Warm winnter <br />
                      collection 2021
                    </h2>
                    <Link
                      href="#!"
                      className="btn btn-pink2 text-white text-uppercase rounded-pill fw-semibold"
                    >
                      shop now
                    </Link>
                  </div>
              ...
              <div className="position-absolute top-50 start-0 w-100 translate-middle-y">
                <div className="row align-items-center justify-content-center pt-5 pb-4">
                  <div className="col-lg-5 text-white mb-4 mb-md-0">
                    <p className="text-center text-lg-start fs-22 mb-0">
                      Subscribe Now!
                    </p>
                  </div>
                    ...
                    <form id="contact_form" className="d-block">
                      <div className="footer-subscribe position-relative">
                        <input
                          ...
                          className="input-text form-control form-control-lg text-white py-3 w-100 rounded-pill bg-transparent text-white text-opacity-75 fs-14"
                          required
                        />
                        <button
                          type="submit"
                          className="btn btn-dark position-absolute kids-subscribe-btn rounded-pill"
                        >
                          <span>Subscribe</span>
                        </button>
                      </div>
