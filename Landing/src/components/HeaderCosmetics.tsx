...
import green1 from "@assets/images/home-cosmetics/Baskio-green-01.png";
import green2 from "@assets/images/home-cosmetics/Baskio-green-02.png";
                ...
                <div className="text-center">
                  <Link className="navbar-brand mx-auto" href="/index">
                    ...
                    <Image
                      src={green2}
                      alt=""
                      className="max-w-100 d-lg-none d-block"
                      style={{ height: "40px" }}
                    />
                  </Link>
                </div>
              ...
              <div className="col-lg-5 col">
                <div className="topbar-toolbar ms-auto d-flex align-items-center gap-3 justify-content-end cosmetics-header">
                  ...
                  <Link href="#!" className="d-none d-md-block">
                    ...
                    <span className="tcount bg-lima text-white rounded-circle d-flex align-items-center justify-content-center">
                      3
                    </span>
                  </Link>
                  <Link
