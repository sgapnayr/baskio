      ...
      <div>
        <div className="my-3">
          ...
          <div className="Baskio-rating-result">
            <span className="Baskio-rating-result__pipe">{stars}</span>
        ...
        <div className="topbar-product-card desgin_1 bg-muted">
          <div className="position-relative overflow-hidden">
            ...
            <div
              className="product2-button position-absolute d-lg-none bottom-0 end-0 d-flex flex-column rounded-pill m-2"
              style={{ zIndex: 1 }}
            >
              <Link
                href="#exampleModal"
  ...
  return (
    <React.Fragment>
      <div className="container-fluid bg-white px-4 py-5 ">
        <div className="Baskio-medical-deal-section kids-deal-section">
