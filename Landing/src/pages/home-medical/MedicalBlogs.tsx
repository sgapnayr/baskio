...
const blogPosts = [
  {
    ...
    image: post1,
    content:
      "Spain’s death rate continues to fall. The country reported 399 deaths in 24 hours, lower than Sunday’s figure of 41...",
  ...
  },
  {
    ...
    image: post2,
    content:
      "Only a tiny proportion of the global population – maybe as few as 2% or 3% – appear to have antibodies in the blood...",
    link: "/blog-post-with-instagram-shop",
  },
  {
    ...
    image: post3,
    content:
      "But a standout image by photographer Alyson McClaran came on Sunday from Denver, Colorado. As protesters gathered...",
    link: "/blog-post-with-instagram-shop",
  },
  {
    ...
    image: post4,
    content:
      "Helen Simmons, a 28-year-old film producer from London, went into labor with her second child on the evening...",
    link: "/blog-post-with-instagram-shop",
  },
];
...
const MedicalBlogs = () => {
  return (
    <React.Fragment>
      <section className="Baskio-medical-blog-post shop-categories">
        <Container>
          <Row className="justify-content-between align-items-center mb-4">
            ...
            <Col className="col-auto text-end">
              <Link
                href="#!"
                className="main_link_primary text-decoration-underline"
              >
                See all Posts
              </Link>
            </Col>
            ...
            {blogPosts.map((post, index) => (
              <Col key={index} lg={3} sm={6} className="my-3 my-lg-0 px-2">
                <div className="blog-card">
                  ...
                  <h6 className="fs-16 mt-3 main_link_primary text-truncate">
                    <Link
                  ...
                  <div className="post-content text-muted mt-3">
                    Spain’s death rate continues to fall The country reported
                    399 deaths in 24 hours, lower than Sunday’s figure of 41...
                  </div>
                  {/* <Card.Body>
