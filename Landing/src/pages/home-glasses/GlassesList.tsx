...
const GlassesList = () => {
  return (
    <React.Fragment>
      <section className="Baskio-glasses-vertical-products border-top py-5">
              ...
              <div className="vstack gap-3">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <div className="flex-grow-1 overflow-hidden">
                    <h6 className="font-montserrat text-truncate mb-1">
                      <Link href="#!" className="main_link_mustard">
