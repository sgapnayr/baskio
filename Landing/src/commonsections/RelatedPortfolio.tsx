  ...
  return (
    <React.Fragment>
      <div className="d-flex justify-content-center mb-4">
        <h4 className="fw-bold">RELATED PORTFOLIO</h4>
      </div>
      <div className="row py-2 blog-arrow Baskio-blog-grid pb-5 mb-4 related-slideshow">
        {Portfolio.map((item: any, index: number) => {
          return (
            <div
              key={index}
              className="col-md-4 col-sm-6 px-2 slideshow__slide"
            >
              <Link
                href="/shop"
