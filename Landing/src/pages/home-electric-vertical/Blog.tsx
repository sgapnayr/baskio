          ...
          >
            <div className="col-sm-6 col-lg-4 px-2">
              <div className="blog-card">
                ...
                <h6 className="fs-16 mt-3 main_link_mustard lh-base">
                  ...
                  >
                    Dial and Disc Wireless Chargers home office from Sum
                  </Link>
                </h6>
                ...
                <div className="post-content text-muted mt-3">
                  Sleek, minimalist wireless charging designs to
                  &quot;complement and blend within the home and office&quot;.
                </div>
              </div>
            </div>
            <div className="col-sm-6 col-lg-4 px-2">
              <div className="blog-card">
                ...
                <h6 className="fs-16 mt-3 main_link_mustard lh-base">
                  <Link
                    ...
                    className="text-reset"
                  >
                    The Headphones Can Translate 11 Languages Wireless Speaker
                  </Link>
                </h6>
                <div className="d-flex gap-1 align-items-center text-muted">
                  By
                ...
                <div className="post-content text-muted mt-3">
                  These 3-in-1 headphones can snap together and turn into a
                  wireless speaker.
                </div>
              </div>
            </div>
            <div className="col-sm-6 col-lg-4 px-2">
              <div className="blog-card">
                ...
                <div className="post-content text-muted mt-3">
                  Microsoft unveils the cool grey, minimalist voice-controlled
                  Surface Headphones.
                </div>
              </div>
            </div>
