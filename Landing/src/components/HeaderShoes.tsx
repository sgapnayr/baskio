      ...
      >
        ...
        <div className="mt-4">
          ...
          <p className="mb-0 fs-14 text-muted">
            ...
            <span className={product.originalPrice ? "text-danger" : ""}>
              {product.price}
            </span>
          </p>
        </div>
...
const HeaderShoes = () => {
  ...
  const handleClickOutside = (event: any) => {
    if (headerRef.current && !event.target.closest(".shoes-header")) {
      setShoww(null);
    }
  };
        ...
        >
          <div className="container-fluid">
            ...
            >
              <ul className="navbar-nav mx-auto mb-2 mb-lg-0 shoes-header">
                ...
                <li className="nav-item dropdown dropdown-mega-xxl">
                  ...
                  <div
                    className={`dropdown-menu p-3 ${showw === 2 ? "show" : ""}`}
                  >
                    <Row className="g-0">
                      <Col lg={7}>
                        <Row className="g-0">
            ...
            <div className="topbar-toolbar d-flex align-items-center gap-3 shoes-header">
              ...
              >
                <i
                  className="iccl iccl-search fw-medium"
