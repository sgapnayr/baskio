            ...
            <div className="accordion-item border-0 mb-2">
              <h2 className="accordion-header">
                ...
                >
                  Description
                  <span
                    className="bg-dark position-absolute end-0"
              ...
              >
                <div className="accordion-body border border-top-0 border-light">
                  ...
                  <p className="mb-0">
                    ...
                    warranty from the time of purchase. If you feel your product
                    meets these requirements, please email{" "}
                  ...
                  <p className="mb-4">
                    ...
                    U.S. on orders over $150. FedEx 2-Day packages are delivered
                  ...
                  <p className="mb-4">
                    Free returns are available on all U.S. order within 14 days
                    of shipment.
                  </p>
                ...
                <div className="accordion-body">
                  ...
                  <div className="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div className="d-flex mt-3 mt-sm-0">
                      <Link
                        href="#!"
                        className="text-muted me-2 py-1 px-2 sub-gray"
                      >
                        Filter
                        <span>
                          <Image src={icondown} alt="" />
                        </span>
                      </Link>
                      <Link
                        href="#!"
                  ...
                  <Row className="g-3">
                    <Col sm={6} md={4}>
                      <Card>
                        <CardBody>
                          <div
                            className=" rounded-pill d-inline-block align-items-center p-1"
                            style={{ backgroundColor: "#f2f2f2" }}
                          >
