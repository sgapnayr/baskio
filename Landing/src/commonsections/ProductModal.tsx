            ...
            >
              <div className="pt-30 ps-4 ps-md-0 pe-4">
                  ...
                  >
                    <div className="Baskio-rating-result">
                      <span className="Baskio-rating-result__pipe">
                        <span className="Baskio-rating-result__start"></span>
                        &nbsp;
                        <span className="Baskio-rating-result__start"></span>
                        &nbsp;
                        <span className="Baskio-rating-result__start"></span>
                        &nbsp;
                        <span className="Baskio-rating-result__start active"></span>
                        &nbsp;
                        <span className="Baskio-rating-result__start de-active"></span>
                        &nbsp;
                      </span>
                      <span className="Baskio-rating-result__number">
                        (12 reviews)
                      </span>
                      &nbsp;
                    </div>
                ...
                <p className="text-muted">
                  ...
                  and white kicks for a stylish Baskio vibe.
                </p>
                ...
                <div className="mt-4">
                  <p className="text-muted mb-1">
                    <span className="text-body">SKU:</span> 4540967714955-111
                  </p>
                  <p className="text-muted mb-1">
                    <span className="text-body">Categories:</span>{" "}
                    <Link href="#!" className="main_link text-muted">
                      Accessories
                    </Link>
                    ,{" "}
                    <a href="#!" className="main_link text-muted">
                      All
                    </a>
                    ,{" "}
                    <a href="#!" className="main_link text-muted">
                ...
                <div>
                  <div className="social-share mt-4 mb-3">
                    ...
                    <Link href="https://www.google.com/gmail/about">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 32 32"
                        className="at-icon at-icon-email Baskio-social-media__btn"
                      >
                        <g>
                  ...
                  <Link href="#" className="fw-medium detail_link ">
