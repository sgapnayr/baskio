...
const ProductSwiper = ({ handleShoppingShow }: any) => {
  ...
  const handleQuantityChange1 = (change: number) => {
  ...
  const handleQuantityChange4 = (change: number) => {
                ...
                <tr>
                  ...
                  <td>
                    <div className="p-lg-3 text-center">
                      ...
                      <select
                        className="form-select form-select-sm rounded-0 py-2 my-3"
                      ...
                      <p className="text-muted mb-0">
                        $45.00 <del className="text-danger">$20.00</del>
                      </p>
                    </div>
                  </td>
                  <td>
                  ...
                  <td>
                    <div className="input-step border border-muted mt-5 ms-lg-4 ">
                      <Button
                        type="button"
                        className="minus material-shadow text-dark fw-bold"
                        onClick={() => handleQuantityChange3(-1)}
                      >
                        –
                      </Button>
                      <input
                ...
                <tr>
                  ...
                  <td>
                    <div className="p-lg-3 text-center">
                      ...
                      <p className="text-muted mb-0">
                        $45.00 <del className="text-danger">$30.00</del>
                      </p>
                    </div>
                  </td>
                  <td>
                    <div className="input-step border border-muted mt-5 ms-lg-4 ">
                      <Button
                        type="button"
                        className="minus material-shadow text-dark fw-bold"
                        onClick={() => handleQuantityChange4(-1)}
                      >
                        –
                      </Button>
                      <input
