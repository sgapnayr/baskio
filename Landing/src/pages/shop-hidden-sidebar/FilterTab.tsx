    ...
    <>
      ...
      >
        <div className="position-relative overflow-hidden">
          {product.label && (
            <span
              className={`new-label ${product.labelClass} text-white rounded-circle`}
            >
              {product.label}
            </span>
          )}
          ...
          <Link
            href="#"
            className="wishlistadd text-white position-absolute"
        ...
        <div className="mt-3">
          <h6 className="mb-1 fw-medium">
            <Link
              ...
              className="main_link_acid_green"
            >
              {product.title}
            </Link>
          </h6>
    ...
    <React.Fragment>
      <div className="container">
        <div className=" mt-5 d-flex justify-content-between align-items-center">
          ...
          <Dropdown>
            <Dropdown.Toggle
              className="btn d-flex align-items-center justify-content-between featurnBtn rounded-pill"
              type="button"
        ...
        <div
          className={`p-4 filter-box ${open === false ? "" : "d-none"} mt-4`}
        >
              ...
              <div className="mt-3 filter-category">
                {vendorData.map((item: any, index: number) => {
                  return (
                    <div
                      key={index}
                      className="round d-flex align-items-center pt-2 mb-2 gap-1"
                    >
                      <input
                        className={`form-check-input ${item.color}`}
                        type="checkbox"
                        id="colo1"
                      />
                      <label
