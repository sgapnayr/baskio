          ...
          <div className="row accordion" id="footer-accordion">
            <div className="col-md-4 col-lg-3 mb-2 footer-accordion-item accordion-item">
              ...
              >
                <h3>
                  {" "}
                  <i className="pegk pe-7s-headphones me-1 align-middle me-2"></i>
                </h3>
                <h5> Got Questions ?</h5>
              </button>
              <div
              ...
              >
                <h5 className="fw-medium d-none d-md-flex text-uppercase mb-4 pb-2">
                  <i className="pegk pe-7s-headphones fs-20 me-1 align-middle me-2"></i>
                  GOT QUESTIONS ?
                </h5>
                <div className="my-3">
                  <div className="pb-3">
            ...
            <div className="col-md-3 col-lg-2 mb-2 accordion-item footer-accordion-item">
              ...
              <h5 className="fw-medium d-none d-md-block fs-16">
                Useful links
              </h5>
              <div
                id="collapseFour"
            ...
            <div className="col-md-10 col-lg-3 mb-2 footer-accordion-item">
              ...
              >
                <h5 className="fw-medium">
                  {" "}
                  <i className="pegk pe-7s-cash align-middle me-2 fs-20"></i>
