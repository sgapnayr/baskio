        ...
        <Row className="py-3 gx-xl-1">
            ...
            <Row className="g-2">
              ...
              <Col xl={9} className="mt-3 order-1 order-xl-2">
                ...
                >
                  <div className="swiper-wrapper">
                    <SwiperSlide>
                      <Image src={thumb01} alt="" className="img-fluid w-100" />
                    </SwiperSlide>
                    <SwiperSlide>
                      <Image src={thumb02} alt="" className="img-fluid w-100" />
                    </SwiperSlide>
                    <SwiperSlide>
                      <Image src={thumb01} alt="" className="img-fluid w-100" />
                    </SwiperSlide>
          ...
          <Col md={6} className="mt-5 mt-md-0">
            ...
            <p className="text-muted">
              <span>
                <i className="cd mr__5 fading_true fs__20 las la-fire me-1"></i>
              </span>
              <span className="text-black">25</span> sold in last{" "}
            ...
            <p className="text-black text-center mt-4">
              <span>
                <i className="cd mr__5 fading_true fs__20 las la-hourglass-half"></i>
              </span>
