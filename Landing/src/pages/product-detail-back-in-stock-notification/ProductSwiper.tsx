            ...
            <Col md={6} className="mt-5 mt-md-0">
              ...
              <div className="d-flex flex-wrap justify-content-between">
                <p className="text-muted fs-18 mb-4">
                  <span className="product-detail-back-in-stock-notification">
                    $85.00
                  </span>
                </p>
              ...
              <div className="d-flex flex-wrap align-items-center gap-2 mt-4">
                <Button
                  variant=""
                  className="btn btn-outline-dark fw-medium border-2 fw-semibold rounded-pill min-w-150"
              ...
              <Link href="#!">
                <div className="btn btn-outline-dark border-2 fw-semibold rounded-pill min-w-150 mt-2">
                  Email Me When Avilable
                </div>
              </Link>
