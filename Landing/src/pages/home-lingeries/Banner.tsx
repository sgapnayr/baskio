...
const Banner = () => {
  const banner = [
    {
      ...
      title: "Summer Wear",
      day: "Collection 2024",
      extraclass: "justify-content-end",
    },
    { id: 2, pic: banner2, title: "Trending Item", day: "Sale Of The Day" },
  ];
  ...
  return (
    <React.Fragment>
            ...
            {banner.map((item) => (
              <Col md={6} key={item.id}>
                ...
                >
                  ...
                  />
                  <div
                    className={`position-absolute start-0 start-0 end-0 top-0 bottom-0 d-flex align-items-center  mx-4 ${item.extraclass}`}
                  >
                    <div className="text-white text-end">
                      <h4 className="fs-24 font-futura fw-medium mb-4">
                        {item.title} <br /> {item.day}
                      </h4>
      ...
      <section className="Baskio-lingerie-newsletter">
        <div className="container py-4">
          <div className="row justify-content-center">
            <div className="col-lg-6 col-md-10">
              <h1 className="font-futura fs-45 fw-medium text-center">
                Get Daily Update For Deals & Exclusive Discount
              </h1>
            </div>
          </div>
            ...
            <div className="col-lg-7 col-md-10">
              <form action="#!" className="signup-newsletter-form row g-0">
                ...
                <div className="col-md-auto col-12">
                  <button
                    type="submit"
                    className="btn_icon_true btn bg-dark border-dark rounded-0 text-white w-100 w-md-auto"
                  >
                    Subscribe{" "}
                  </button>
                </div>
