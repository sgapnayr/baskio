        ...
        <Container>
          <div className="row g-4">
            <Col md={6}>
              <Link
                href="/shop"
                className="d-block position-relative cat_grid_item overflow-hidden h-250"
              >
                <div
                ...
                <div className="position-absolute start-0 bottom-0 end-0 top-0 end-0 d-flex align-items-center text-body m-4 p-2">
                  <div>
                    <h4 className="text-body font-avenir">
                      Baskio is an online shop for handicrafts.
                    </h4>
                    <p className="text-muted mb-0">
                      Crafting beautiful stuff with our own hands and the help
                      from useful tools is a wonderful process.
                    </p>
                  </div>
                </div>
              </Link>
              ...
              >
                ...
                <div className="position-absolute start-0 bottom-0 end-0 top-0 end-0 d-flex align-items-center text-muted text-center justify-content-center m-4 p-2">
                  <div>
                    ...
                    <h4 className="fw-medium fs-24 mb-0">@Baskio_store</h4>
                  </div>
                </div>
              </Link>
            </Col>
