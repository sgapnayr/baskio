...
const HomeDecor = () => {
  return (
    <React.Fragment>
      ...
      <div>
        {/* main slide */}
        <section className="position-relative Baskio-decor overflow-hidden">
            ...
            <Row>
              <Col lg={12}>
                <Image
                  src={slide}
                  alt=""
                  className="w-100 img-fluid Baskio-decor-img"
                />
                ...
                <div className="position-absolute top-0 start-0 end-0 bottom-0 text-center py-5 text-white d-flex align-items-center justify-content-center">
                  <div className="pt-5 pt-sm-0">
                    <h1 className="text-capitalize summer-tag fw-medium main-title mb-4 pb-2 ">
                      interior decorations
                    </h1>
                    <h3 className=" font-secondary  fw-normal fst-italic mb-4">
                      looking for furniture for your living room
                    </h3>
                    <Link
                      href="/shop"
                      className="btn btn-custom stretched-link fw-medium min-w-150 rounded-0 d-inline-flex align-items-center justify-content-center"
                    >
                      Shop Now&nbsp;<i className="las la-arrow-right"></i>
                    </Link>
                  </div>
                </div>
              </Col>
        ...
        {/* cat section */}
        <section className="mt-3 Baskio-decor-cat-banner-layout bg-light">
          <Container fluid>
            <Row className="g-3">
                ...
                <Col key={index} md={6} lg={4}>
                  ...
                  >
                    ...
                    <div
                      className={
                        item.direction
                          ? "position-absolute start-0 start-0 end-0 top-0 bottom-0 align-items-end justify-content-end text-end d-flex m-3"
                          : "position-absolute start-0 start-0 end-0 top-0 bottom-0 d-flex m-3"
                      }
                    >
                      <div className={item.text ? "text-dark" : "text-white"}>
                        ...
                        <p
                          className={
                            item.text
                              ? "fw-semibold font-futura mb-0 btn_icon_true dark d-inline-block position-relative fs-16"
                              : "fw-semibold font-futura mb-0 btn_icon_true d-inline-block position-relative fs-16"
                          }
                        >
                          {item.btntext}
                        </p>
