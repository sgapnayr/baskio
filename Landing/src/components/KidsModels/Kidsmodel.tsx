...
const KidsModel = ({ show, handleKisdModelClose }: any) => {
  return (
    <React.Fragment>
      <Modal
        show={show}
        onHide={handleKisdModelClose}
        centered
        className="modal-overl pin_popup"
      >
        <Modal.Body className="p-20">
          <div className="topbar-product-card">
            ...
            <div className="mt-3 text-center">
              ...
              <div className="Baskio-rating-result justify-content-center">
                ...
                <span className="Baskio-rating-result__number cp text-muted">
                  (6)
                </span>
              </div>
            </div>
