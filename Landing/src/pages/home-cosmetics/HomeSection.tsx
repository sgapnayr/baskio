...
const HomeSection = () => {
  ...
  return (
    <React.Fragment>
      <section className="Baskio-home-section type_slideshow type_carousel Baskio-medical Baskio-cosmetics overflow-hidden">
                ...
                <Row>
                  <Col lg={4} className="offset-md-1">
                    <div className="content">
                      <h5 className="text-uppercase fs-13 text-lima ls-normal">
                        {item.new}
                      </h5>
                      {item.desc2 ? (
                        ...
                        <h1 className="fs-55 font-playfair fw-semibold text-white mb-3">
                          {item.desc1}
                        </h1>
                      )}
                      <Link
