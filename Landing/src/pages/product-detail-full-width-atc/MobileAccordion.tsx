                  ...
                  <Row className="pt-3">
                    <Col lg={6} className="text-center text-muted">
                      ...
                      <p>
                        ...
                        stylish sporty vibe. Will fit a UK 8-10, model shown is
                        a UK 8 and 5’5. !!
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        never seen before in the Combat Drop Arm Tank, including
                        a freedom-instilling regular fit and dropped armhole to
                        allow you to throw jabs and hooks at the punching bag
                        with ease. A lightweight material keeps you fighting
                        fit, and fresh.
                      </p>
                    </Col>
                    <Col lg={6}>
