          ...
          >
            <Row className="nav tab_header justify-content-center">
              <Col>
                <Nav
                  variant="pills"
                  className="tab_header justify-content-center"
                >
                  <Nav.Item>
                    <Nav.Link
            ...
            <Tab.Content className="mt-5">
                  ...
                  <Col md={3} className="col-6">
                    <div className="insta-card position-relative">
                      ...
                      <Link
                        ...
                        className="card-spin position-01 position-absolute fs-14 bg-dark text-white rounded-circle fw-semibold"
                        onClick={handleShow}
                      >
                        1
                      </Link>
                  ...
                  <Col lg={3} className="col-6">
                    <div className="insta-card position-relative">
                      ...
                      <Link
                        ...
                        data-bs-toggle="modal"
                        data-bs-target="#exampleModal"
                        className="card-spin position-02 position-absolute fs-14 bg-dark text-white rounded-circle fw-semibold"
                        onClick={handleShow}
                      >
                        1
                      </Link>
                  ...
                  <Col lg={3} className="col-6">
                    <div className="insta-card position-relative">
                      ...
                      <Link
                        ...
                        data-bs-toggle="modal"
                        data-bs-target="#exampleModal"
                        className="card-spin position-03 position-absolute fs-14 bg-dark text-white rounded-circle fw-semibold"
                        onClick={handleShow}
                      >
                        1
                      </Link>
                      <Link
                        ...
                        data-bs-toggle="modal"
                        data-bs-target="#exampleModal"
                        className="card-spin position-04 position-absolute fs-14 bg-dark text-white rounded-circle fw-semibold"
                        onClick={handleShow}
                      >
                        2
                      </Link>
                  ...
                  <Col lg={3} className="col-6">
                    <div className="insta-card position-relative">
                      ...
                      <Link
                        ...
                        data-bs-toggle="modal"
                        data-bs-target="#exampleModal"
                        className="card-spin position-05 position-absolute fs-14 bg-dark text-white rounded-circle fw-semibold"
                        onClick={handleShow}
                      >
                        1
                      </Link>
                  ...
                  <Col lg={3} className="col-6">
                    <div className="insta-card position-relative">
                      ...
                      <Link
                        ...
                        data-bs-toggle="modal"
                        data-bs-target="#exampleModal"
                        className="card-spin position-06 position-absolute fs-14 bg-dark text-white rounded-circle fw-semibold"
                        onClick={handleShow}
                      >
                        1
                      </Link>
                  ...
                  <Col lg={3} className="col-6">
                    <div className="insta-card position-relative">
                      ...
                      <Link
                        ...
                        data-bs-toggle="modal"
                        data-bs-target="#exampleModal"
                        className="card-spin position-07 position-absolute fs-14 bg-dark text-white rounded-circle fw-semibold"
                        onClick={handleShow}
                      >
                        1
                      </Link>
              ...
              <Tab.Pane eventKey="Warrantyshipping">
                ...
                <p className="mb-0">
                  If issues experienced with the frame include a
                  manufacturer&apos;s defect, or an issue resulting from an
                  inherent flaw in the product, RAEN provides a 365 day warranty
                  from the time of purchase. If you feel your product meets
                  these requirements, please email{" "}
                  <Link href="#!">warranty@domain.com</Link> explaining the
                  nature of your warranty claim and all necessary details.
                </p>
                <p className="mb-4">
                  Scratched lenses and physical damage are not covered by
                  warranty. Unfortunately we do not manufacture or sell
                  replacement lenses.
                </p>
                <h6 className="fw-bold">Free FedEx 2-Day Shipping</h6>
                <p className="mb-4">
                  Free FedEx 2-Day Shipping is available exclusively to the U.S.
                  on orders over $150. FedEx 2-Day packages are delivered Monday
                  through Friday.
                </p>
                <h6 className="fw-bold">Free FedEx Ground Shipping</h6>
                <p className="mb-4">
                  Free FedEx Ground Shipping is available exclusively to U.S.
                  orders over $100.
                </p>
                <h6 className="fw-bold">Free Returns</h6>
                <p className="mb-4">
                  Free returns are available on all U.S. order within 14 days of
                  shipment.
                </p>
                <p className="fst-italic fw-medium">
                  *Free Shipping is not available with some promotions and other
                ...
                <Row className="mb-3">
                  <Col md={2} className="text-center">
                    ...
                    <div className="Baskio-rating-result">
                      <span className="Baskio-rating-result__pipe ,b-1">
                        <span className="Baskio-rating-result__start Baskio-rating-result__start--big me-1"></span>
                        <span className="Baskio-rating-result__start Baskio-rating-result__start--big me-1"></span>
                        <span className="Baskio-rating-result__start Baskio-rating-result__start--big me-1"></span>
                        <span className="Baskio-rating-result__start Baskio-rating-result__start--big active me-1"></span>
                        <span className="text-muted Baskio-rating-result__start Baskio-rating-result__start--big me-1"></span>
                      </span>
                    </div>
                  ...
                  <Col md={4}>
                    ...
                    <div className="d-flex align-items-center my-2">
                      <p className="mb-0 me-2 text-nowrap text-muted">
                        Very Good{" "}
                      </p>
                      <input
                        type="range"
                    ...
                    <div className="d-flex align-items-center my-2">
                      <p className="mb-0 pe-2 me-4 text-nowrap text-muted">
                        Poor
                      </p>
                      <input
                        type="range"
                      ...
                      <CardBody>
                        <div className="rounded-pill d-inline-block align-items-center p-1 bg-light">
                          <div className="d-flex align-items-center">
                            <p
                              className="mb-0 rounded-pill  bg-warning text-white d-inline-block text-center d-flex justify-content-center align-items-center"
                        ...
                        <div className="Baskio-rating-result my-2">
                          <span className="Baskio-rating-result__pipe ,b-1">
                            <span className="Baskio-rating-result__start Baskio-rating-result__start--big me-1"></span>
                            <span className="Baskio-rating-result__start Baskio-rating-result__start--big me-1"></span>
                            <span className="Baskio-rating-result__start Baskio-rating-result__start--big me-1"></span>
                    ...
                    <Card>
                      <CardBody>
                        <div className="rounded-pill d-inline-block align-items-center p-1 bg-light">
                          <div className="d-flex align-items-center">
                            <p
                              className="mb-0 rounded-pill  bg-danger text-white d-inline-block text-center d-flex justify-content-center align-items-center"
                              style={{ width: "25px", height: "25px" }}
                            >
                              K
                            </p>
                    ...
                    <Card>
                      <CardBody>
                        <div className="rounded-pill d-inline-block align-items-center p-1 bg-light">
                          <div className="d-flex align-items-center">
                            <p
                              className="mb-0 rounded-pill  bg-primary text-white d-inline-block text-center d-flex justify-content-center align-items-center"
                              style={{ width: "25px", height: "25px" }}
                            >
                              G
                            </p>
                    ...
                    <Card>
                      <CardBody>
                        <div className="rounded-pill d-inline-block align-items-center p-1 bg-light">
                          <div className="d-flex align-items-center">
                            <p
                              className="mb-0 rounded-pill  bg-info text-white d-inline-block text-center d-flex justify-content-center align-items-center"
                              style={{ width: "25px", height: "25px" }}
                            >
                              C
                            </p>
          ...
          <Modal show={review} onHide={reviewClose} centered>
            <Modal.Body className="p-4">
              ...
              <div className="border p-3 rounded-1">
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-2 w-100">
                    <h6 className="mb-1 fs-14 fw-bold">
                    ...
                    <div className="d-flex align-items-center gap-2">
                      <div className="Baskio-rating-result">
                        <span className="Baskio-rating-result__pipe ,b-1">
                          ...
                          <span className="text-muted Baskio-rating-result__start Baskio-rating-result__start--big"></span>
                        </span>
                      </div>
              ...
              <div className="d-flex align-items-center gap-4 mt-3">
                ...
                <div className="Baskio-rating-result">
                  <span className="Baskio-rating-result__pipe ,b-1">
                    <span className="Baskio-rating-result__start Baskio-rating-result__start--lg Baskio-rating-result__start--big"></span>
                    <span className="Baskio-rating-result__start Baskio-rating-result__start--lg Baskio-rating-result__start--big"></span>
                    <span className="Baskio-rating-result__start Baskio-rating-result__start--lg Baskio-rating-result__start--big"></span>
                    <span className="Baskio-rating-result__start Baskio-rating-result__start--lg Baskio-rating-result__start--big active"></span>
                    <span className="text-muted Baskio-rating-result__start Baskio-rating-result__start--lg Baskio-rating-result__start--big"></span>
                  </span>
                </div>
              </div>
              <div className="mb-3">
                <label
                  htmlFor="name"
                  role="button"
                  className="fw-medium mb-2 text-muted"
                >
                  Your Name*
                </label>
                <input
              ...
              <button
                type="button"
                data-bs-toggle="modal"
                data-bs-target="#rateUsModel012"
                className="btn btn-warning rounded-1 py-2 px-2 fw-semibold"
                onClick={handleClose}
              >
                Submit Your Review
              </button>
