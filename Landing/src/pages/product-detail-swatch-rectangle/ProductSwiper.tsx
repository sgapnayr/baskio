                  ...
                  >
                    <div className="swiper-wrapper">
                      <div className="swiper-wrapper">
                        <SwiperSlide>
                          <Image
                            className="drift-demo-trigger img-fluid w-100"
                            src={product4}
                            alt=""
                          />
                        </SwiperSlide>
              ...
              <div className="custome-radio">
                ...
                <div className="color-list mt-2 d-flex align-items-center">
                  <Link
                    href="#!"
                    onClick={(e) => {
                      handleColorClick("Gray");
                    }}
                  >
                    <div
                      className={`button ${color === "Gray" ? "active" : ""}`}
                    >
                      <input
                        type="radio"
                        id="gray"
                  ...
                  >
                    <div
                      className={`button ${color === "Pink" ? "active" : ""}`}
                    >
                      <input
                        type="radio"
                        id="pink"
                  ...
                  >
                    <div
                      className={`button ${color === "Black" ? "active" : ""}`}
                    >
                      <input
                        type="radio"
                        id="black"
                  ...
                  >
                    <div className={`button ${size === "S" ? "active" : ""}`}>
                      <input
                        ...
                        readOnly
                      />
                      <label htmlFor="sizeS" style={{ width: "32px" }}>
                        S
                      </label>
                    </div>
                  </Link>
                  ...
                  >
                    <div className={`button ${size === "M" ? "active" : ""}`}>
                      <input
                        ...
                        readOnly
                      />
                      <label htmlFor="sizeM" style={{ width: "32px" }}>
                        M
                      </label>
                    </div>
                  </Link>
                  ...
                  >
                    <div className={`button ${size === "L" ? "active" : ""}`}>
                      <input
                        ...
                        readOnly
                      />
                      <label htmlFor="sizeL" style={{ width: "32px" }}>
                        L
                      </label>
                    </div>
                  </Link>
