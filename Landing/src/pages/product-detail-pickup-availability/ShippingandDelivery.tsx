...
const ShippingandDelivery = ({ handleShoppingShow }: any) => {
    ...
    <React.Fragment>
      <Col lg={6} className="mt-5 mt-xl-0">
        ...
        <p className="text-muted">
          Orange you glad to be standing fit and healthy on your feet? Whether
          skateboarding on the streets or rushing to make it to the front of a
          music gig, these orange...
        </p>
        <div className="d-flex flex-wrap align-items-center gap-2 mt-4">
          ...
          <button
            className={`btn btn-danger-dark text-uppercase rounded-pill min-w-150 ${
        ...
        <div className="text-black fs-12 d-flex mt-5">
          ...
          <p className="ms-1">
            ...
            <span className="fw-medium border-bottom">
              Friday, 29th January and Wednesday, 3rd February
            </span>
          </p>
        </div>
        <div className="text-black fs-12 d-flex">
          ...
          <p className="ms-1">
            <span className="fw-medium border-bottom">85 People </span> are
