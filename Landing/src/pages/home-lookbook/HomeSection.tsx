    ...
    <React.Fragment>
      <section className="position-relative home-lookbook-section">
        <div className="slideshow">
          {/* first slide */}
          <div
            className="slideshow__slide w-100 Baskio-lookbook-home"
          ...
          >
            <div className="pin-type position-absolute position-08">
              ...
              <Link
                ...
                className="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center position-relative"
                data-bs-toggle="modal"
                onClick={handleRightModal10Show}
              >
                <i className="nav_link_icon position-relative"></i>
              </Link>
            </div>
        ...
        <div
          className="modal fade modal-overl pin_popup"
          id="pinType1"
          tabIndex={-1}
          aria-labelledby="pinType1Label"
          aria-hidden="true"
        >
      ...
      />
      <CapModal
        modalShow7={modalShow7}
        handleRightModal7Close={handleRightModal7Close}
      />
      <ProductInfoModal2
        modalShow8={modalShow8}
        handleRightModal8Close={handleRightModal8Close}
      />
      <ProductInfoModal3
        modalShow9={modalShow9}
        handleRightModal9Close={handleRightModal9Close}
      />
      <WatchModal
        modalShow10={modalShow10}
        handleRightModal10Close={handleRightModal10Close}
      />
    </React.Fragment>
  );
};
