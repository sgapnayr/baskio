            ...
            <Col md={4}>
              <div className="blog-card">
                ...
                <h6 className="fs-16 mt-3 main_link_primary mb-2">
                  ...
                  >
                    5 Ways to Play: Florals at home!
                  </Link>
                </h6>
                <div className="post-content text-muted">
                  Dried flower straw wreathes are super fun and easy to make.
                  Don&apos;t have dried flowers? We couldn’t be more thrilled
                  ...
                </div>
              </div>
            </Col>
              ...
              <div className="blog-card">
                ...
                <h6 className="fs-16 mt-3 main_link_primary mb-2">
                  <Link
                    ...
                    className="text-reset"
                  >
                    Ed Alfrey and Warner Brothers Event
                  </Link>
                </h6>
                <div className="post-content text-muted">
                  Flowers look great in a vase, but if you&apos;ve got a little
                  extra time at home these days and need a fun project, here...
                </div>
              </div>
            </Col>
            <Col md={4}>
              <div className="blog-card">
                ...
                <div className="post-content text-muted">
                  In January, WildFlora got the opportunity to once again work
                  with Fundamental Events Catering (always a pleasure!) ...
                </div>
              </div>
            </Col>
          </Row>
