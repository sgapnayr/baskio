                  ...
                  <form id="contact_form" className="d-block">
                    <div className="footer-subscribe position-relative">
                      <input
                        ...
                        className="input-text text-white form-control w-100 rounded-pill text-white bg-transparent"
                        required
                      />
                      <button
                        type="submit"
                        className="btn bg-black fw-semibold text-white position-absolute rounded-pill"
                      >
                        <span>Subscribe</span>
                      </button>
                    </div>
        ...
        <Container>
          <Row>
            ...
            <Col lg={6}>
              <ul
                id="footer-menu"
                className="list-unstyled d-flex align-items-center mb-0 justify-content-lg-end"
              >
                <li className="menu-item ">
