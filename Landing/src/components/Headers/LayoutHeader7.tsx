...
import {
  ...
  Lookbook,
  Blog,
} from "@src/common/Header/mobileHeader";
...
const LayoutHeader7 = () => {
  ...
  return (
    <React.Fragment>
      <div id="Baskio-section-header_top" className="{{ class-name }}">
        ...
        <nav className="navbar navbar-expand-lg navbar-custom py-5 align-items-start vertical-menu d-none d-lg-block">
          <div className="container-fluid">
            ...
            <div className="text-end position-relative pt-3 pb-4">
              <Dropdown>
                <Dropdown.Toggle
                  ...
                  id="currency-dropdown"
                >
                  <Image src={usd} alt="USD" height="12" className="me-1" /> USD{" "}
                  <i className="facl facl-angle-down"></i>
                </Dropdown.Toggle>
            ...
            <div
              className="navbar-nav w-100 header-offcanvas collapse navbar-collapse border-e"
              ...
              <div className="tab-content w-100" id="pills-tabContent">
                ...
                >
                  ...
                  >
                    ...
                    <div className="accordion-item py-3">
                      <Link
                        href="#!"
                        className="d-block pill-item col-6 px-1 text-danger lh-sm"
                        role="presentation"
                      >
                        Sale{" "}
                        <span className="badge bg-warning rounded-pill fw-normal">
                          Sale
                        </span>
                      </Link>
                    </div>
                    ...
                    <div className="accordion-item">
                      <h2
                        className="accordion-header"
                        id="panelsStayOpen-headingNight"
                      >
                        <button
                          className={`accordion-button px-1 ${
                            blog === true ? "" : "collapsed"
                          ...
                          type="button"
                          data-bs-toggle="collapse"
                          data-bs-target="#panelsStayOpen-collapseNight"
                          aria-expanded="false"
                      ...
                      <div
                        id="panelsStayOpen-collapseNight"
                        className={`accordion-collapse collapse ${
                          blog === true ? "show" : ""
                        }`}
                ...
                >
                  <ul className="accordion-nav-list accordion-navs-list list-unstyled mb-0">
                    <li>
                      <a href="#">
                        <i className="las la-female me-2"></i>Women’s Clothing
                      </a>
                    </li>
                  </ul>
                </div>
      ...
      <nav className="navbar navbar-expand-lg navbar-custom py-2 d-flex align-items-center d-lg-none">
        <div className="container-fluid">
          ...
          <div
            className="topbar-toolbar d-flex align-items-center gap-3"
            onClick={handleShow}
          >
            <Link
              href="#!"
