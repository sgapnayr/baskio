          ...
          <div className="row g-3">
            {data.map((item) => (
              <div className="col-md-6 col-lg-4" key={item.id}>
                <Link
                  href="/shop"
                  className="d-inline-block Baskio-medical-banner-01 position-relative img-zoom w-100"
                >
                  ...
                  {item.label === true ? (
                    <div className="content position-absolute text-white start-50 translate-middle text-center w-100">
                      <div>
                        <h3 className="font-montserrat fw-bold fs-60 text-uppercase">
                          {item.name}
                        </h3>
                    ...
                    <div className="content position-absolute text-white">
                      ...
                      <h3 className="font-montserrat fw-bold fs-36 text-uppercase">
                        {item.desc}
                      </h3>
                    </div>
                  )}
