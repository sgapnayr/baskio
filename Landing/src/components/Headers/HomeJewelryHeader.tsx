    ...
    <>
      ...
      >
        <div className="position-relative overflow-hidden main">
          ...
          <div
            className="position-absolute d-lg-none bottom-0 end-0 d-flex flex-column bg-orange m-2"
            style={{ zIndex: 1 }}
          >
            <Link
              href="#exampleModal"
                  ...
                  <div className="d-none d-lg-block">
                    <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                      <li className="nav-item dropdown dropdown-mega-xxl">
                        <span
                          className={`nav-link fs-16 fw-medium ${
                            showw === 1 ? "show" : ""
                          }`}
                      ...
                      <li className="nav-item dropdown dropdown-mega-xxl">
                        <span
                          className={`nav-link fs-16 position-relative fw-medium ${
                            showw === 2 ? "show" : ""
                          }`}
                          data-bs-toggle="dropdown"
                          aria-expanded="false"
                        ...
                        <div
                          className={`dropdown-menu ms-0 p-3 ${
                            showw === 2 ? "show" : ""
                          }`}
                        >
                          <Row className="g-0">
                      ...
                      <li className="nav-item dropdown dropdown-mega-3xl">
                        <span
                          className={`nav-link fs-16 fw-medium position-relative ${
                            showw === 5 ? "show" : ""
                          }`}
                          role="button"
                          data-bs-toggle="dropdown"
              ...
              <div className="col-lg-5 col-auto">
                <div className="topbar-toolbar ms-auto d-flex align-items-center gap-3 justify-content-end">
                  <Link
                    ...
                    onClick={handleShow}
                  >
                    <i className="las la-search fs-28"></i>
                  </Link>
                  <Link
                  ...
                  >
                    <i
                      className="las la-shopping-cart fs-28"
