...
import {
  ...
  ShopFeatures2,
  ProductDetail2,
} from "@src/common/Header/header2";
import {
  HomePage1,
  HomePage2,
  HeaderLayout,
    ...
    >
      ...
      <div className="mt-4 text-center">
        <h6 className="mb-1 text-capitalize fs-14 fw-medium">
          <Link href={product.link} className="main_link_teal">
            {product.title}
          </Link>
        </h6>
        {product.del ? (
...
const LayoutHeader8 = () => {
  ...
  return (
    <React.Fragment>
      <div id="Baskio-section-header_top" className="demo">
            ...
            <Row className="align-items-center justify-content-center py-3 py-xl-0">
              <Col md={5} lg={3} className="col-12">
                <div className="nt-social text-center text-lg-start">
                  <Link
                    href="#"
                    className="facebook cb ttip_nt tooltip_bottom_right text-black fs-16 me-3"
                  >
                    <i className="facl facl-facebook"></i>
                  </Link>
                  <Link
                    href="#"
                    className="twitter cb ttip_nt tooltip_bottom_right text-black fs-16 me-3"
                  >
                    &nbsp;
                  ...
                  <Link
                    href="#"
                    className="instagram cb ttip_nt tooltip_bottom_right text-black fs-16 me-3"
                  >
                    &nbsp;
                  ...
                  <Link
                    href="#"
                    className="linkedin cb ttip_nt tooltip_bottom_right text-black fs-16 me-3"
                  >
                    &nbsp;
                  ...
                  <Link
                    href="#"
                    className="pinterest cb ttip_nt tooltip_bottom_right text-black fs-16 me-3"
                  >
                    &nbsp;
              ...
              <Col md={5} lg={6} className="col-12">
                <div className="header-text text-center fs-12 py-1 py-lg-0">
                  Summer sale discount off <span className="cr">20%</span>use
                  code “SUMMER20”!{" "}
                  <Link href="shop.html" className="text-reset">
                    <span className="text-danger">Shop Now</span>
                  </Link>
                </div>
              </Col>
              <Col md={2} lg={3} className="col-12">
                <Dropdown className="text-center text-md-end position-relative">
                  ...
                  >
                    <Image src={usd} alt="USD" height="12" className="me-1" />{" "}
        ...
        <nav
          className={`navbar navbar-expand-lg navbar-custom pt-4 pb-0 d-block align-items-center demo ${
                ...
                <div className="row">
                  ...
                  <div className="col-6 mb-lg-3">
                    <form
                      action="#"
                      method="get"
                      className="electrict-input"
                      role="search"
                    >
                      <div className="footer-subscribe position-relative electrict-input">
                        <select
                          name="product_type"
                          className="position-absolute top-0 left-0 categories text-muted"
                        >
                        ...
                        <div>
                          <input
                            ...
                            className={`input-text input-search form-control w-100 rounded-pill dropdown-toggle ${
                              showw === 7 ? "show" : ""
                            }`}
                            autoComplete="off"
                            required
                          ...
                          />
                          <div
                            className={`dropdown-menu start-0 end-0 overflow-x-hidden overflow-y-auto  ${
                              showw === 7 ? "show" : ""
                            }`}
                            style={{ maxHeight: "50vh", marginTop: "2px" }}
                          >
                            ...
                            <Link href="#" className="btn detail_link">
                              View All(107)
                        ...
                        <button
                          type="submit"
                          className="btn btn-teal position-absolute search-btn rounded-pill top-0 end-0"
                        >
                          <span>Search</span>
                        </button>
                      </div>
                  ...
                  <div className="col-3">
                    <div className="topbar-toolbar d-flex justify-content-end align-items-center gap-3">
                      ...
                      <Link className="d-md-block d-none" href="#!">
              ...
              <div className="d-flex justify-content-between">
                <ul className="navbar-nav mb-2 mb-lg-0">
                  <li className="nav-item dropdown dropdown-mega-lg">
                    <Link
                      className={`nav-link text-uppercase text-white d-flex align-items-center fw-medium ${
                        showw === 1 ? "show" : ""
                      }`}
                      style={{ backgroundColor: "#007e91", height: "50px" }}
                      href="#"
                      role="button"
                      data-bs-toggle="dropdown"
                      aria-expanded="false"
                    ...
                    >
                      <i className="las la-bars mr__5 fs-18 me-1"></i> Shop by
                      category
                    </Link>
                    <ul
                      className={`dropdown-menu dropdown-sub-column p-2 ${
                        showw === 1 ? "show" : ""
                      }`}
                    >
                      {LayoutHeaderDataCatogory.map(
                                  ...
                                  return (
                                    <li key={index}>
                                      ...
                                      >
                                        {item.lable}
                                        <span
                                          className={item.badgeColor2}
                                          style={item.badstyle2}
                                        >
                                          {item.badge2}
                                        </span>
                                      </Link>
                ...
                <div className="d-flex align-items-xl-center justify-content-center justify-content-md-start gap-3">
                  <Link
                    ...
                    className="mb-0 text-white fs-12"
                  >
