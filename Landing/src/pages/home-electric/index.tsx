...
const blog = [
  {
    ...
    author: true,
    excerpt:
      'Sleek, minimalist wireless charging designs to "complement and blend within the home and office".',
  },
  {
    id: 2,
    imageUrl: blog2,
    ...
    author: true,
    excerpt:
      "These 3-in-1 headphones can snap together and turn into a wireless speaker.",
  },
  {
    id: 3,
    imageUrl: blog3,
        ...
        >
          ...
          <div className="mt-4 text-center">
            ...
            <p className="mb-0 fs-14 text-muted">
              ...
              <span className={product.oldPrice ? "text-danger" : ""}>
                {product.newPrice}
              </span>
            </p>
          </div>
...
const HomeElectric = () => {
  ...
  return (
    <React.Fragment>
      ...
      {/* main slide */}
      <div>
        <section className="position-relative Baskio-decor Baskio-categories-link-banner overflow-hidden">
            ...
            <Row>
              <Col lg={12}>
                <Image
                  src={main}
                  alt=""
                  className="Baskio-decor-img img-fluid w-100"
                />
                ...
                <div className="position-absolute top-0 start-0 end-0 bottom-0 text-center py-5 d-flex align-items-center justify-content-center">
                  <div>
                    <h1 className="decor-title mt-5 mt-sm-0 mb-4 px-2 px-md-0 fw-semibold">
                      Decor your home with smart devices
                    </h1>
                    <Link
                      href="/shop"
                      className="btn btn-custom stretched-link text-white fw-medium min-w-150 rounded-0 d-inline-flex align-items-center justify-content-center"
                    >
                      Shop Now
                    </Link>
                  </div>
          ...
          <div className="row g-4">
            {catsection.map((item: any, index: number) => (
              <Col key={index} md={4}>
                <Link
                  href="#!"
                  className="d-block position-relative cat_grid_item overflow-hidden h-300"
                >
                  <div
      ...
      <section className="type_tab_collection pb-5 pt-0">
        <div className="container">
          ...
          <div className="text-center mt-4 pt-2">
            <Link
              href="#!"
              className="btn btn-dark btn-lg btn_icon_true min-w-150 px-5 fs-14 py-3 rounded-0"
            >
              Load More
            </Link>
          </div>
      ...
      {/* blog */}
      <section className="Baskio-section_type_featured_blog Baskio-decor-02-blog-post">
        <Container>
          <div className="row justify-content-center">
            <div className="col-lg-7">
              ...
              <Col key={index} sm={6} lg={4} className="px-2">
                <div className="blog-card">
                  <Link
                    ...
                    className="overflow-hidden d-block blog-wrap"
                  >
                    <Image
                      src={blog.imageUrl}
                      alt=""
                      className="blog-img object-fit-cover w-100"
                    />
                  </Link>
                  <h6 className="fs-16 mt-3 main_link_mustard lh-base">
                    <Link
                      href="/blog-post-with-instagram-shop"
                  ...
                  <div className="post-content text-muted mt-3">
                    {blog.excerpt}
                  </div>
                </div>
              </Col>
      ...
      {/* newsletter */}
      <section className="Baskio-electric-newsletter py-5 ">
        <Container>
              ...
              <form id="contact_form" className="d-block mt-4 pt-2 mx-lg-5">
                <div className="footer-subscribe position-relative mx-lg-5">
                  <input
                    ...
                    className="input-text form-control w-100 rounded-pill py-3"
                    required
                  />
                  <button
                    type="submit"
