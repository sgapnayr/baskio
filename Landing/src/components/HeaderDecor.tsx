...
import {
  ...
  ProductSwatch,
  ProductFeatures,
} from "@src/common/Header/headershoes";
import {
  HeaderLayout,
  HomePage1,
  HomePage2,
...
const SwiperCard = ({ product }: any) => {
  ...
  return (
    <>
      <div
        className="topbar-product-card px-3 pt-2"
...
const HeaderDecor = () => {
  ...
  const handleClickOutside = (event: any) => {
    if (headerRef.current && !event.target.closest(".header-decor")) {
      setShoww(null);
    }
  };
      ...
      >
        <nav
          className={`navbar navbar-expand-lg navbar-custom py-0 d-flex align-items-center px-lg-3 ${
            ...
            showMenuScroll === true ? "bg-body navbar-scroll shadow-sm" : ""
          }`}
        >
                  ...
                  <div className="d-none d-lg-block mx-auto">
                    <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                      <li className="nav-item dropdown dropdown-mega-xxl">
                        <span
                          className={`nav-link fw-medium fs-16 ${
                            showw === 1 ? "show" : ""
                          }`}
                      ...
                      <li className="nav-item dropdown dropdown-mega-xxl">
                        <span
                          className={`nav-link fw-medium fs-16 position-relative ${
                            showw === 2 ? "show" : ""
                          }`}
                          data-bs-toggle="dropdown"
                          aria-expanded="false"
                      ...
                      <li className="nav-item dropdown dropdown-mega-lg">
                        ...
                        <ul
                          className={`dropdown-menu ms-0 dropdown-sub-column ${
                            showw === 6 ? "show" : ""
                          }`}
                        >
