...
const Collections = () => {
  ...
  const handleImageChange = (newImageUrl: string | any) => {
      ...
      <section>
        <Container>
          <Row className="g-lg-4 g-3 gy-md-0 gy-4 align-items-center">
            ...
            <Col md={4}>
              <div className="Baskio-banner-promotion topbar-product-card">
                <div className="position-relative overflow-hidden">
                  ...
                  <div className="product-size text-center d-none d-lg-block">
                    ...
                    <div className="product-color-list mt-1 gap-2 d-flex align-items-center justify-content-center p-2">
                      <Link
                        href="#!"
                        onMouseOver={() => handleImageChange(pr24)}
                        onClick={(e) => {
                          e.preventDefault();
                          handleImageChange(pr24);
                        }}
                        className="d-inline-block bg_color_pink rounded-circle"
                      ></Link>
                      <Link
                        href="#!"
                        onMouseOver={() => handleImageChange(pr25)}
                        onClick={(e) => {
                          e.preventDefault();
                          handleImageChange(pr25);
                        }}
                  ...
                  <div
                    className="count-time d-none d-lg-block"
                    data-date="10-10-2028"
                  >
                    <ul className="list-unstyled d-flex gap-2 align-items-center text-center justify-content-center mb-0">
                      <li className="bg-dark text-white text-white-50 fs-12 rounded">
                        <span className="days text-white fs-14">0</span>days
                      </li>
                      <li className="bg-dark text-white text-white-50 fs-12 rounded">
                        <span className="text-white fs-14">00</span>Hours
                      </li>
                      <li className="bg-dark text-white text-white-50 fs-12 rounded">
                        <span className="min text-white fs-14">00</span>Minutes
                      </li>
                      <li className="bg-dark text-white text-white-50 fs-12 rounded">
                        <span className="sc text-white fs-14">00</span>Seconds
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="d-lg-none">
                  ...
                  <div
                    className="count-time position-relative mt-4 d-lg-block d-none"
                    data-date="10-10-2028"
                  >
                    <ul className="list-unstyled d-flex gap-2 align-items-center text-center justify-content-center mb-0">
                      <li
                        className="bg-dark text-white text-white-50 fs-12 rounded"
                        style={{ minWidth: "50px" }}
                      >
                        <span className="days text-white fs-14">0</span>days
                      </li>
            ...
            <Col md={4}>
              <Link href="/shop" className="Baskio-banner-promotion d-block">
                ...
                <div className="p-20 position-absolute top-50 end-0 text-body start-0 content-position text-center">
                  <p className="text-uppercase fw-medium fs-18 mb-1">
                    Men Collection
                  </p>
                  <h3 className="fs-50">SALE 70%</h3>
                  <Button variant="custom-dark fw-medium min-w-150 rounded-pill">
                    Shop Now
                  </Button>
                </div>
              </Link>
