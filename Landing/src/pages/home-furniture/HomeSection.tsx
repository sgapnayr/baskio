...
const HomeSection = () => {
  ...
  return (
    <React.Fragment>
      <section
        className="Baskio-home-furniture position-relative home-lookbook-section"
      ...
      >
        <div className="pin-type position-absolute position-01">
          ...
          <Link
            href="#pinType1"
            className="bg-warning text-white rounded-circle d-flex align-items-center justify-content-center position-relative"
            onClick={handleShow}
          >
