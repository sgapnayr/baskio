  ...
  return (
    <React.Fragment>
      ...
      <div className="page-vertical-wrapper">
        {/* main */}
        <div className="Baskio-home-section type_slideshow type_carousel">
                ...
                <div className="row justify-content-end">
                  <div className="text-center d-flex justify-content-end">
                    <div data-aos="fade-right" data-aos-delay="300">
                      ...
                      <h1 className="summer-tag fw-semibold mb-3">
                        CLEARANCE SALE OFF 70%
                      </h1>
                      <Link
                ...
                <div className="row justify-content-end">
                  <div className="col-md-6">
                    ...
                    >
                      ...
                      <h3 className="display-4 fw-semibold mb-3">
                        Lookbook Collection
                      </h3>
                      <Link
                        className="btn btn-dark rounded-0 min-w-150 text-white"
