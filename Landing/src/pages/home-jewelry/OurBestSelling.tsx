...
const sellingData = [
  ...
  },
  {
    ...
    price: "$2,395.00",
    colors: [pr19, pr20, pr31, pr32, pr33],
  },
  {
    imageUrl: pr21,
    hoverImageUrl: pr22,
  ...
  },
  {
    ...
    price: "$1,575.00",
    colors: [pr29, pr30, pr37, pr38, pr39, pr40],
  },
];
      ...
      <div className="col-lg-3 col-6 col-md-4">
        ...
        >
          <div className="position-relative overflow-hidden">
            {item.label && (
              <span
                className={`onsale position-absolute ${item.labelClass} text-white d-flex align-items-center justify-content-center z-3`}
              >
                {item.label}
              </span>
            )}
            ...
            <div
              className="position-absolute d-lg-none bottom-0 end-0 d-flex flex-column bg-white m-2"
              style={{ zIndex: 1 }}
            >
              <Link
                href="#exampleModal"
              ...
              <div className="text-center mb-5">
                <div>
                  ...
                  <span className="dn tt_divider">
                    <span></span>
                    <i className="la la-close fs-14 text-muted"></i>
                    <span></span>
                  </span>
                </div>
