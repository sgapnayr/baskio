...
const FooterSports = () => {
  ...
  return (
    <React.Fragment>
        ...
        <div className="container">
          <div className="row accordion" id="footer-accordion">
            <div className="col-md-4 col-lg-3 mb-2 footer-accordion-item accordion-item">
              <button
                className={`accordion-button footer-accordion-button  px-0 ${
                  open === 1 ? "" : "collapsed"
                }`}
                type="button"
                ...
                <div className="mt-4 pt-2">
                  ...
                  <div className="footer-social d-flex align-items-center gap-4 mt-4">
                    <Link
                      ...
                      className="d-inline-block fs-16 text-white"
                      data-bs-toggle="tooltip"
                      data-bs-placement="top"
                      data-bs-title="Follow on Facebook"
                    >
                    ...
                    <Link
                      ...
                      data-bs-toggle="tooltip"
                      data-bs-placement="top"
                      data-bs-title="Follow on Twitter"
                    >
                    ...
                    <Link
                      ...
                      data-bs-toggle="tooltip"
                      data-bs-placement="top"
                      data-bs-title="Follow on Instagram"
                    >
                    ...
                    <Link
                      ...
                      data-bs-toggle="tooltip"
                      data-bs-placement="top"
                      data-bs-title="Follow on LinkedIn"
                    >
                    ...
                    <Link
                      ...
                      data-bs-toggle="tooltip"
                      data-bs-placement="top"
                      data-bs-title="Follow on Pinterest"
                    >
            ...
            <div className="col-md-2 col-lg-2 mb-2 accordion-item footer-accordion-item">
              ...
              <h5 className="fw-medium d-none d-md-block text-white">
                Categories
              </h5>
              <div
                id="collapseTwo"
                ...
                <div className="mt-lg-4 pt-2">
                  <ul className="menu list-unstyled">
                    <li className="menu-item">
                      <Link href="/shop-filter-sidebar" className="text-white">
                        Celebrations
                      </Link>
                    </li>
                    <li className="menu-item">
                    ...
                    <li className="menu-item">
                      <Link href="/shop-1600px-layout" className="text-white">
                        Home Decor
                      </Link>
                    </li>
                    <li className="menu-item">
              ...
              >
                <div className="mt-lg-4 pt-2">
                  ...
                  <form id="contact_form" className="d-block">
                    <div className="footer-subscribe footer-subscribe-sport position-relative">
                      <input
                        ...
                        className="input-text form-control w-100 rounded-0 text-white bg-transparent"
                        required
                      />
                      <button
                        type="submit"
                        className="btn bg-orange text-white position-absolute rounded-0"
                      >
                        <span>Subscribe</span>
                      </button>
                    </div>
                  ...
                  <div className="mt-3">
                    ...
                    <Link href="#!">
                      <Image src={payment3} alt="" className="img-fluid" />
                    </Link>
                    <Link href="#!">
                      <Image src={payment4} alt="" className="img-fluid" />
                    </Link>
                    <Link href="#!">
                      <Image src={payment5} alt="" className="img-fluid" />
                    </Link>
                    <Link href="#!">
                      <Image src={payment6} alt="" className="img-fluid" />
                    </Link>
                    <Link href="#!">
                      <Image src={payment7} alt="" className="img-fluid" />
                    </Link>
                    <Link href="#!">
                      <Image src={payment8} alt="" className="img-fluid" />
                    </Link>
                  </div>
                </div>
              </div>
      ...
      <div
        className="footer-alt mb-5 mb-lg-0 py-4 footer-dark text-white"
        ...
        <Container>
          <Row>
            ...
            <Col lg={6}>
              <ul
                id="footer-menu"
                className="list-unstyled d-flex align-items-center mb-0 justify-content-lg-end mt-2 mt-lg-0"
              >
                <li className="menu-item ">
                  <Link href="/shop-filter-sidebar" className="mx-2 text-white">
                    Shop
                  </Link>
                </li>
                <li className="menu-item ">
