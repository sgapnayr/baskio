        ...
        <div className="col-md-9 col-lg-10">
          <div className="row">
            ...
            <div className="col-sm-6 col-md-4 col-xl-3 px-4">
              ...
              >
                {product.buttons &&
                  product.buttons.map((button: any, index: any) => (
                    <Link
                      key={index}
  ...
  return (
    <React.Fragment>
      <div className="mt-5 d-flex justify-content-between align-items-center">
        ...
        <ul
          className="nav tab_header tab_filter gap-2 justify-content-end justify-content-sm-center"
          id="pills-tab"
          role="tablist"
        >
          <li className="nav-item d-sm-none" role="presentation">
            <button
              className={`nav-link ${display === 6 ? "active" : ""}`}
              id="best-pan1-tab"
              data-bs-toggle="pill"
              data-bs-target="#best-pan1"
              type="button"
              role="tab"
              aria-controls="best-pan1"
              aria-selected="true"
          ...
          <li className="nav-item d-none d-lg-block" role="presentation">
            <button
              className={`nav-link ${display === 4 ? "active" : ""}`}
              id="top-sale-tab"
              data-bs-toggle="pill"
              data-bs-target="#top-sale"
              type="button"
              role="tab"
              aria-controls="top-sale"
              aria-selected="false"
          ...
          <li className="nav-item d-none d-xl-block" role="presentation">
            <button
              className={`nav-link ${display === 5 ? "active" : ""}`}
              id="top-product-tab"
              data-bs-toggle="pill"
              data-bs-target="#top-product"
              type="button"
              role="tab"
              aria-controls="top-product"
              aria-selected="false"
            ...
            <div className="mt-3">
              ...
              <div className="form-check mb-2">
                <input
                  ...
                  type="checkbox"
                  defaultValue=""
                  id="flexCheckChecked51"
                  style={{ cursor: "pointer" }}
                />
                <label
                  className="form-check-label"
                  htmlFor="flexCheckChecked51"
                  style={{ cursor: "pointer" }}
                >
              ...
              <div className="form-check mb-2">
                <input
                  ...
                  type="checkbox"
                  defaultValue=""
                  id="flexCheckChecked61"
                  style={{ cursor: "pointer" }}
                />
                <label
                  className="form-check-label"
                  htmlFor="flexCheckChecked61"
                  style={{ cursor: "pointer" }}
                >
          ...
          <Col sm={6} lg={3}>
            ...
            <div className="mt-3 filter-category">
              <div className="round d-flex align-items-center mb-2">
                <input
                  className="form-check-input bg-black border-black p-1"
                  type="checkbox"
                  defaultValue=""
                  id="colo1"
                />
              ...
              <div className="round d-flex align-items-center mb-2">
                <input
                  className="form-check-input bg-teal border-teal p-1"
                  type="checkbox"
                  defaultValue=""
                  id="color2"
                />
              ...
              <div className="round d-flex align-items-center mb-2">
                <input
                  className="form-check-input bg-green2 p-1"
                  type="checkbox"
                  defaultValue=""
                  id="color3"
                />
              ...
              <div className="round d-flex align-items-center mb-2">
                <input
                  className="form-check-input bg-cid-green border-cid-green p-1"
                  type="checkbox"
                  defaultValue=""
                  id="color4"
                />
              ...
              <div className="round d-flex align-items-center mb-2">
                <input
                  className="form-check-input bg-pink2 border-pink2 p-1"
                  type="checkbox"
                  defaultValue=""
                  id="color5"
                />
              ...
              <div className="round d-flex align-items-center mb-2">
                <input
                  className="form-check-input bg-sea border-sea p-1"
                  type="checkbox"
                  defaultValue=""
                  id="color6"
                />
              ...
              <div className="round d-flex align-items-center mb-2">
                <input
                  className="form-check-input bg-blue-dark border-blue-dark p-1"
                  type="checkbox"
                  defaultValue=""
                  id="color7"
                />
              ...
              <div className="round d-flex align-items-center mb-2">
                <input
                  className="form-check-input bg-red border-red p-1"
                  type="checkbox"
                  defaultValue=""
                  id="color8"
                />
              ...
              <div className="round d-flex align-items-center mb-2">
                <input
                  className="form-check-input bg-orange p-1 border-orange"
                  type="checkbox"
                  defaultValue=""
                  id="color9"
                />
          ...
          <div className="col-sm-6 col-lg-3">
            ...
            <form action="" className="mt-5">
              ...
              <p className="fw-medium text-black fs-14 mt-4">
                <span className="text-muted fw-normal me-2">Price</span>$
      ...
      <div className="tab-content my-3 my-md-4" id="pills-tabContent">
        <div
          className={`tab-pane fade ${display === 6 ? "active show" : ""}`}
          id="best-pan1"
          role="tabpanel"
        ...
        <div
          className={`tab-pane fade ${display === 1 ? "active show" : ""}`}
          id="best-seller"
          role="tabpanel"
        ...
        <div
          className={`tab-pane fade ${display === 2 ? "active show" : ""}`}
          id="featured"
          role="tabpanel"
          aria-labelledby="featured-tab"
          tabIndex={0}
        >
          <section className="Baskio-shoes-grid-products-section pb-0">
        ...
        <div
          className={`tab-pane fade ${display === 4 ? "active show" : ""}`}
          id="top-sale"
          role="tabpanel"
          aria-labelledby="top-sale-tab"
          tabIndex={0}
        >
          <section className="Baskio-shoes-grid-products-section pb-0">
            <div className="container-fluid px-0">
        ...
        <div
          className={`tab-pane fade ${display === 5 ? "active show" : ""}`}
          id="top-product"
          role="tabpanel"
