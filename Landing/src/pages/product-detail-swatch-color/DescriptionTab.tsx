                ...
                <Row className="pt-3">
                  <Col lg={6}>
                    ...
                    <p>
                      ...
                      stylish sporty vibe. Will fit a UK 8-10, model shown is a
                      UK 8 and 5’5. !!
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      freedom-instilling regular fit and dropped armhole to
                      allow you to throw jabs and hooks at the punching bag with
                      ease. A lightweight material keeps you fighting fit, and
                      fresh.
                    </p>
                  </Col>
                  <Col lg={6}>
                    ...
                    <table className="table table-bordered">
                      <thead>
                        <tr>
                          <th scope="col" className="bg-transparent fw-medium">
                            SIZE
                          </th>
                          <th scope="col" className="bg-transparent fw-medium">
                            CHEST
                      ...
                      <tbody>
                        <tr>
                          <th className="bg-transparent fw-medium" scope="row">
                            S
                          </th>
