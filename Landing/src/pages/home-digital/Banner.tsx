          ...
          <div className="row g-4">
            <Col lg={6}>
              ...
              >
                <Image
                  src={banner1}
                  alt=""
                  className="img-fluid hover-zoom-img"
                />
            ...
            <Col lg={6}>
              ...
              >
                ...
                <div className="position-absolute start-0 start-0 end-0 top-0 bottom-0 d-flex align-items-center">
                  <div className="m-3 m-sm-4 px-sm-3 text-body">
                    <h4 className="fs-30" style={{ whiteSpace: "nowrap" }}>
                      New SmartWatch
                    </h4>
              ...
              >
                ...
                <div className="position-absolute start-0 start-0 end-0 top-0 bottom-0 d-flex align-items-center">
                  <div className="m-3 m-sm-4 px-sm-3 text-body">
                    ...
                    <h6 className="mb-4 fs-16">
                      Engineered to run on ultra-fast <br /> networks.
                    </h6>
                    <p className="btn text-dark fw-semibold border border-2 border-dark rounded-pill min-w-150">
                      Buy Now
                    </p>
              ...
              >
                ...
                <div className="position-absolute start-0 start-0 end-0 top-0 bottom-0 d-flex align-items-center">
                  <div className="m-3 m-sm-4 px-sm-3 text-body">
                    ...
                    <h6 className="mb-4 fs-16">
                      Plus earn 2% back in Baskio <br /> rewards.
                    </h6>
                    <p className="btn text-dark fw-semibold border border-2 border-dark rounded-pill min-w-150">
                      Buy Now
                    </p>
