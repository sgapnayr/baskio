      ...
      >
        ...
        <div className="mt-3">
          <h6 className="mb-1 fs-16 fw-medium">
            <Link href={product.productDetailLink} className="main_link_red">
              {product.title}
            </Link>
          </h6>
            ...
            <div className="product-color-list mt-2 gap-2 d-flex align-items-center">
              {product.colorOptions.map((color: any, index: number) => (
                <Link
                  ...
                  className={`d-inline-block rounded-circle ${color.color}`}
                ></Link>
              ))}
            </div>
          )}
                              ...
                              {ProductDetail.map((item: any, index: number) => {
                                return (
                                  <li key={index}>
                                    ...
                                    >
                                      {item.label}
                                      <span className={item.homebagbadgeColor}>
                                        {item.homebagbadge}
                                      </span>
                                    </Link>
                                  </li>
