...
const LatestNews = () => {
  return (
    <React.Fragment>
      <section className="Baskio-section_type_featured_blog">
        <Container>
              ...
              <div className="text-center mb-4">
                <div>
                  ...
                  <span className="dn tt_divider">
                    <span></span>
                    <i className="la la-glasses text-muted"></i>
                    <span></span>
                  </span>
                </div>
                <p className="fs-14 text-muted mt-2 mb-0">
                  Finding eyeglasses with the qualities that are most important
                  to you could be as simple as choosing a frame material each
              ...
              <div className="blog-card">
                ...
                <h6 className="fs-16 mt-3 main_link_mustard font-montserrat">
                  <Link
                    ...
                    className="text-reset main_link_mustard"
                  >
                    Eyeglasses that Suit Your Personality
                  </Link>
                </h6>
                ...
                <div className="post-content text-muted mt-3">
                  Because people generally recognize you by your face, the
                  eyeglasses you wear are a very real part of your identity....
                </div>
              </div>
            </Col>
            <Col md={6} lg={4} className="px-2">
              <div className="blog-card">
                ...
                <div className="post-content text-muted mt-3">
                  For most Americans, eyeglasses are an indispensable part of
                  our daily lives. In the United States, more than 6 out...
                </div>
              </div>
            </Col>
            <Col md={6} lg={4} className="px-2">
              <div className="blog-card">
                ...
                <div className="post-content text-muted mt-3">
                  When it comes to getting a pair of glasses, looks can be
                  deceiving. We see them as functional fashion, but in reali...
                </div>
              </div>
            </Col>
          </Row>
