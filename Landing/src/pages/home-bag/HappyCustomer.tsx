...
const HappyCustomer = () => {
  return (
    <React.Fragment>
      <section className="Baskio-furniture-testimonial pt-3">
        <Container>
          <Row className="justify-content-center">
            <Col lg={7}>
              <div className="text-center">
                ...
                <span className="fs-14 text-uppercase ls-normal text-muted">
              ...
              <Col lg={4} key={item.id}>
                <div className="quote_slide border">
                  <p className="text-muted fs-14">
                    Amazing theme and top class support, as I’m a beginner, Luke
                    helped me above and beyond and was more than patient, his
                    responses were quick and he has a genuine care for you to
                    enjoy and move forward with your theme!
                  </p>
