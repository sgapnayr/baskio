    ...
    <React.Fragment>
      <section className="type_tab_collection pt-0">
        <div className="container">
          <div>
            <ul
              className="nav tab_header gap-lg-4 my-5 justify-content-center"
              id="pills-tab"
              role="tablist"
            >
              <li className="nav-item" role="presentation">
                <button
                  className={`nav-link pill-border rounded-pill ${
                    open === 1 ? "active" : ""
                  }`}
                  id="best-seller-tab"
                  data-bs-toggle="pill"
              ...
              <li className="nav-item" role="presentation">
                <button
                  ...
                  id="handmade-tab"
                  data-bs-toggle="pill"
                  data-bs-target="#handmade"
                  type="button"
                  role="tab"
                  aria-controls="handmade"
                  aria-selected="false"
              ...
              <li className="nav-item" role="presentation">
                <button
                  ...
                  id="top-jewellery-tab"
                  data-bs-toggle="pill"
                  data-bs-target="#top-jewellery"
                  type="button"
                  role="tab"
                  aria-controls="top-jewellery"
                  aria-selected="false"
            ...
            <div className="tab-content mt-4" id="pills-tabContent">
              <div
                className={`tab-pane fade ${open === 1 ? "show active" : ""}`}
                id="best-seller"
                role="tabpanel"
                  ...
                  <Col sm={6}>
                    <Row className="g-2 g-lg-4">
                      <div className="col-12">
                        <Link
                          href="/shop"
                          className="d-lg-block portfolio-img text-black text-center"
                        >
                          <Image
                            src={portfolio1}
                            className="img-fluid"
                          ...
                          />
                          <div
                            className="position-absolute start-50 translate-middle portfolio-card-detail"
                            style={{ zIndex: 2 }}
                          >
                            <h6>WOMEN SHOES</h6>
              ...
              <div
                className={`tab-pane fade ${open === 2 ? "show active" : ""}`}
                id="featured"
                role="tabpanel"
              ...
              <div
                className={`tab-pane fade ${open === 3 ? "show active" : ""}`}
                id="sale"
                role="tabpanel"
              ...
              <div
                className={`tab-pane fade ${open === 4 ? "show active" : ""}`}
                id="top-sale"
                role="tabpanel"
              ...
              <div
                className={`tab-pane fade ${open === 5 ? "show active" : ""}`}
                id="handmade"
                role="tabpanel"
                aria-labelledby="handmade-tab"
                tabIndex={0}
              >
                <Row className="g-2 g-lg-4">
                  <Col sm={6} md={4}>
              ...
              <div
                className={`tab-pane fade ${open === 6 ? "show active" : ""}`}
                id="top-jewellery"
                role="tabpanel"
                aria-labelledby="top-jewellery-tab"
                tabIndex={0}
              >
                <Row className="g-2 g-lg-4">
                  <Col sm={6} md={3}>
